...
public class PresignedUploadResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, upload);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PresignedUploadResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PresignedUploadResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
