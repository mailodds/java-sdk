...
public class AddContact201Response {
  ...
  public AddContact201Response() {
  }

  public AddContact201Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public AddContact201Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public AddContact201Response contact(@javax.annotation.Nullable Object contact) {
  ...
  public void setContact(@javax.annotation.Nullable Object contact) {
    this.contact = contact;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddContact201Response addContact201Response = (AddContact201Response) o;
    return Objects.equals(this.schemaVersion, addContact201Response.schemaVersion) &&
        Objects.equals(this.requestId, addContact201Response.requestId) &&
        Objects.equals(this.contact, addContact201Response.contact);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, contact);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "contact"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddContact201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddContact201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AddContact201Response is not found in the empty JSON string", AddContact201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddContact201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddContact201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddContact201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddContact201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddContact201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddContact201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AddContact201Response>() {
           @Override
           public void write(JsonWriter out, AddContact201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddContact201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddContact201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddContact201Response
   * @throws IOException if the JSON string is invalid with respect to AddContact201Response
   */
  public static AddContact201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddContact201Response.class);
  }

  /**
   * Convert an instance of AddContact201Response to an JSON string
   *
   * @return JSON string
   */
