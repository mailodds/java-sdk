...
public class GetDomainInsightsFunnel200Response {
  ...
  @javax.annotation.Nullable
  private Object funnel;

  public GetDomainInsightsFunnel200Response() {
  }

  public GetDomainInsightsFunnel200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetDomainInsightsFunnel200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetDomainInsightsFunnel200Response funnel(@javax.annotation.Nullable Object funnel) {
    this.funnel = funnel;
    return this;
  }
  ...
  public void setFunnel(@javax.annotation.Nullable Object funnel) {
    this.funnel = funnel;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDomainInsightsFunnel200Response getDomainInsightsFunnel200Response = (GetDomainInsightsFunnel200Response) o;
    return Objects.equals(this.schemaVersion, getDomainInsightsFunnel200Response.schemaVersion) &&
        Objects.equals(this.requestId, getDomainInsightsFunnel200Response.requestId) &&
        Objects.equals(this.funnel, getDomainInsightsFunnel200Response.funnel);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, funnel);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "funnel"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDomainInsightsFunnel200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDomainInsightsFunnel200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetDomainInsightsFunnel200Response is not found in the empty JSON string", GetDomainInsightsFunnel200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDomainInsightsFunnel200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDomainInsightsFunnel200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDomainInsightsFunnel200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDomainInsightsFunnel200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDomainInsightsFunnel200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDomainInsightsFunnel200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDomainInsightsFunnel200Response>() {
           @Override
           public void write(JsonWriter out, GetDomainInsightsFunnel200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDomainInsightsFunnel200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDomainInsightsFunnel200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDomainInsightsFunnel200Response
   * @throws IOException if the JSON string is invalid with respect to GetDomainInsightsFunnel200Response
   */
  public static GetDomainInsightsFunnel200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDomainInsightsFunnel200Response.class);
  }

  /**
   * Convert an instance of GetDomainInsightsFunnel200Response to an JSON string
   *
   * @return JSON string
   */
