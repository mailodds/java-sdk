...
public class GetReputation200Response {
  ...
  public GetReputation200Response() {
  }

  public GetReputation200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetReputation200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetReputation200Response reputation(@javax.annotation.Nullable Object reputation) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.schemaVersion, getReputation200Response.schemaVersion) &&
        Objects.equals(this.requestId, getReputation200Response.requestId) &&
        Objects.equals(this.reputation, getReputation200Response.reputation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, reputation);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "reputation"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetReputation200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetReputation200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetReputation200Response is not found in the empty JSON string", GetReputation200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetReputation200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetReputation200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetReputation200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetReputation200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetReputation200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetReputation200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetReputation200Response>() {
           @Override
           public void write(JsonWriter out, GetReputation200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetReputation200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetReputation200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetReputation200Response
   * @throws IOException if the JSON string is invalid with respect to GetReputation200Response
   */
  public static GetReputation200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetReputation200Response.class);
  }

  /**
   * Convert an instance of GetReputation200Response to an JSON string
   *
   * @return JSON string
   */
