...
import com.mailodds.models.GetBounceRecords200ResponseRecordsInner;
...
public class GetBounceRecords200Response {
  ...
  @javax.annotation.Nullable
  private List<GetBounceRecords200ResponseRecordsInner> records = new ArrayList<>();
  ...
  public GetBounceRecords200Response() {
  }

  public GetBounceRecords200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetBounceRecords200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetBounceRecords200Response records(@javax.annotation.Nullable List<GetBounceRecords200ResponseRecordsInner> records) {
    this.records = records;
    return this;
  }

  public GetBounceRecords200Response addRecordsItem(GetBounceRecords200ResponseRecordsInner recordsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GetBounceRecords200ResponseRecordsInner> getRecords() {
    return records;
  }

  public void setRecords(@javax.annotation.Nullable List<GetBounceRecords200ResponseRecordsInner> records) {
    this.records = records;
  }


  public GetBounceRecords200Response pagination(@javax.annotation.Nullable Pagination pagination) {
  ...
  public boolean equals(Object o) {
    ...
    GetBounceRecords200Response getBounceRecords200Response = (GetBounceRecords200Response) o;
    return Objects.equals(this.schemaVersion, getBounceRecords200Response.schemaVersion) &&
        Objects.equals(this.requestId, getBounceRecords200Response.requestId) &&
        Objects.equals(this.records, getBounceRecords200Response.records) &&
        Objects.equals(this.pagination, getBounceRecords200Response.pagination);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, records, pagination);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "records", "pagination"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBounceRecords200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBounceRecords200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetBounceRecords200Response is not found in the empty JSON string", GetBounceRecords200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBounceRecords200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetBounceRecords200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("records") != null && !jsonObj.get("records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            GetBounceRecords200ResponseRecordsInner.validateJsonElement(jsonArrayrecords.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBounceRecords200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBounceRecords200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBounceRecords200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBounceRecords200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBounceRecords200Response>() {
           @Override
           public void write(JsonWriter out, GetBounceRecords200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBounceRecords200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBounceRecords200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBounceRecords200Response
   * @throws IOException if the JSON string is invalid with respect to GetBounceRecords200Response
   */
  public static GetBounceRecords200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBounceRecords200Response.class);
  }

  /**
   * Convert an instance of GetBounceRecords200Response to an JSON string
   *
   * @return JSON string
   */
