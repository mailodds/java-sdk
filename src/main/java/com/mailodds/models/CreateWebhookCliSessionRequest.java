...
public class CreateWebhookCliSessionRequest {
  public static final String SERIALIZED_NAME_FORWARD_URL = "forward_url";
  @SerializedName(SERIALIZED_NAME_FORWARD_URL)
  @javax.annotation.Nullable
  private String forwardUrl;

  public CreateWebhookCliSessionRequest() {
  }

  public CreateWebhookCliSessionRequest forwardUrl(@javax.annotation.Nullable String forwardUrl) {
  ...
  public boolean equals(Object o) {
    ...
    CreateWebhookCliSessionRequest createWebhookCliSessionRequest = (CreateWebhookCliSessionRequest) o;
    return Objects.equals(this.forwardUrl, createWebhookCliSessionRequest.forwardUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(forwardUrl);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("forward_url"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateWebhookCliSessionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateWebhookCliSessionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateWebhookCliSessionRequest is not found in the empty JSON string", CreateWebhookCliSessionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateWebhookCliSessionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateWebhookCliSessionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("forward_url") != null && !jsonObj.get("forward_url").isJsonNull()) && !jsonObj.get("forward_url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `forward_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("forward_url").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateWebhookCliSessionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateWebhookCliSessionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateWebhookCliSessionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateWebhookCliSessionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateWebhookCliSessionRequest>() {
           @Override
           public void write(JsonWriter out, CreateWebhookCliSessionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateWebhookCliSessionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateWebhookCliSessionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateWebhookCliSessionRequest
   * @throws IOException if the JSON string is invalid with respect to CreateWebhookCliSessionRequest
   */
  public static CreateWebhookCliSessionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateWebhookCliSessionRequest.class);
  }

  /**
   * Convert an instance of CreateWebhookCliSessionRequest to an JSON string
   *
   * @return JSON string
   */
