...
public class ListBlacklistMonitors200Response {
  ...
  @javax.annotation.Nullable
  private List<BlacklistMonitor> monitors = new ArrayList<>();

  public ListBlacklistMonitors200Response() {
  }

  public ListBlacklistMonitors200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public ListBlacklistMonitors200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public ListBlacklistMonitors200Response monitors(@javax.annotation.Nullable List<BlacklistMonitor> monitors) {
    this.monitors = monitors;
    return this;
  }

  public ListBlacklistMonitors200Response addMonitorsItem(BlacklistMonitor monitorsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<BlacklistMonitor> getMonitors() {
    return monitors;
  }

  public void setMonitors(@javax.annotation.Nullable List<BlacklistMonitor> monitors) {
    this.monitors = monitors;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListBlacklistMonitors200Response listBlacklistMonitors200Response = (ListBlacklistMonitors200Response) o;
    return Objects.equals(this.schemaVersion, listBlacklistMonitors200Response.schemaVersion) &&
        Objects.equals(this.requestId, listBlacklistMonitors200Response.requestId) &&
        Objects.equals(this.monitors, listBlacklistMonitors200Response.monitors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, monitors);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "monitors"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListBlacklistMonitors200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListBlacklistMonitors200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListBlacklistMonitors200Response is not found in the empty JSON string", ListBlacklistMonitors200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListBlacklistMonitors200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListBlacklistMonitors200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("monitors") != null && !jsonObj.get("monitors").isJsonNull()) {
        ...
        if (jsonArraymonitors != null) {
          ...
          for (int i = 0; i < jsonArraymonitors.size(); i++) {
            BlacklistMonitor.validateJsonElement(jsonArraymonitors.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListBlacklistMonitors200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListBlacklistMonitors200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListBlacklistMonitors200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListBlacklistMonitors200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ListBlacklistMonitors200Response>() {
           @Override
           public void write(JsonWriter out, ListBlacklistMonitors200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListBlacklistMonitors200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListBlacklistMonitors200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListBlacklistMonitors200Response
   * @throws IOException if the JSON string is invalid with respect to ListBlacklistMonitors200Response
   */
  public static ListBlacklistMonitors200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListBlacklistMonitors200Response.class);
  }

  /**
   * Convert an instance of ListBlacklistMonitors200Response to an JSON string
   *
   * @return JSON string
   */
