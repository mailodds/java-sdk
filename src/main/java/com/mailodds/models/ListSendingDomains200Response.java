...
import com.mailodds.models.SendingDomain;
...
public class ListSendingDomains200Response {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListSendingDomains200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListSendingDomains200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
