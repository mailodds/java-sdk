...
public class GetDomainInsightsTrends200Response {
  ...
  public GetDomainInsightsTrends200Response() {
  }

  public GetDomainInsightsTrends200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetDomainInsightsTrends200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetDomainInsightsTrends200Response trends(@javax.annotation.Nullable List<Object> trends) {
    this.trends = trends;
    return this;
  }

  public GetDomainInsightsTrends200Response addTrendsItem(Object trendsItem) {
    if (this.trends == null) {
  ...
  public void setTrends(@javax.annotation.Nullable List<Object> trends) {
    this.trends = trends;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDomainInsightsTrends200Response getDomainInsightsTrends200Response = (GetDomainInsightsTrends200Response) o;
    return Objects.equals(this.schemaVersion, getDomainInsightsTrends200Response.schemaVersion) &&
        Objects.equals(this.requestId, getDomainInsightsTrends200Response.requestId) &&
        Objects.equals(this.trends, getDomainInsightsTrends200Response.trends);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, trends);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "trends"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDomainInsightsTrends200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDomainInsightsTrends200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetDomainInsightsTrends200Response is not found in the empty JSON string", GetDomainInsightsTrends200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDomainInsightsTrends200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDomainInsightsTrends200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("trends") != null && !jsonObj.get("trends").isJsonNull() && !jsonObj.get("trends").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDomainInsightsTrends200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDomainInsightsTrends200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDomainInsightsTrends200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDomainInsightsTrends200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDomainInsightsTrends200Response>() {
           @Override
           public void write(JsonWriter out, GetDomainInsightsTrends200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDomainInsightsTrends200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDomainInsightsTrends200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDomainInsightsTrends200Response
   * @throws IOException if the JSON string is invalid with respect to GetDomainInsightsTrends200Response
   */
  public static GetDomainInsightsTrends200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDomainInsightsTrends200Response.class);
  }

  /**
   * Convert an instance of GetDomainInsightsTrends200Response to an JSON string
   *
   * @return JSON string
   */
