...
import com.mailodds.models.BatchDeliverResponseDelivery;
import com.mailodds.models.BatchDeliverResponseRejectedInner;
...
public class BatchDeliverResponse {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchDeliverResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BatchDeliverResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
