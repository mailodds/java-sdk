...
public class ListStores200Response {
  ...
  @javax.annotation.Nullable
  private List<StoreConnection> stores = new ArrayList<>();

  public ListStores200Response() {
  }

  public ListStores200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public ListStores200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public ListStores200Response stores(@javax.annotation.Nullable List<StoreConnection> stores) {
    this.stores = stores;
    return this;
  }

  public ListStores200Response addStoresItem(StoreConnection storesItem) {
    if (this.stores == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<StoreConnection> getStores() {
    return stores;
  }

  public void setStores(@javax.annotation.Nullable List<StoreConnection> stores) {
    this.stores = stores;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.schemaVersion, listStores200Response.schemaVersion) &&
        Objects.equals(this.requestId, listStores200Response.requestId) &&
        Objects.equals(this.stores, listStores200Response.stores);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, stores);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "stores"));
      ...
      if (jsonObj.get("stores") != null && !jsonObj.get("stores").isJsonNull()) {
        ...
        if (jsonArraystores != null) {
          ...
          for (int i = 0; i < jsonArraystores.size(); i++) {
            StoreConnection.validateJsonElement(jsonArraystores.get(i));
          };
        }
      }
  }
