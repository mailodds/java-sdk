...
import com.mailodds.models.DeliverResponseDelivery;
...
public class DeliverResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, messageId, status, delivery, validation, contentScan);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeliverResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeliverResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
