...
public class TrackEventRequest {
  ...
  public TrackEventRequest eventType(@javax.annotation.Nonnull EventTypeEnum eventType) {
  ...
  public TrackEventRequest email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public TrackEventRequest properties(@javax.annotation.Nullable Object properties) {
  ...
  public TrackEventRequest occurredAt(@javax.annotation.Nullable OffsetDateTime occurredAt) {
  ...
  public TrackEventRequest idempotencyKey(@javax.annotation.Nullable String idempotencyKey) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventType, trackEventRequest.eventType) &&
        Objects.equals(this.email, trackEventRequest.email) &&
        Objects.equals(this.properties, trackEventRequest.properties) &&
        Objects.equals(this.occurredAt, trackEventRequest.occurredAt) &&
        Objects.equals(this.idempotencyKey, trackEventRequest.idempotencyKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventType, email, properties, occurredAt, idempotencyKey);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("event_type", "email", "properties", "occurred_at", "idempotency_key"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("event_type", "email"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrackEventRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrackEventRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TrackEventRequest is not found in the empty JSON string", TrackEventRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrackEventRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TrackEventRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
