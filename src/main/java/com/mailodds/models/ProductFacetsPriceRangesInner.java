...
public class ProductFacetsPriceRangesInner {
  ...
  public ProductFacetsPriceRangesInner() {
  }

  public ProductFacetsPriceRangesInner range(@javax.annotation.Nullable String range) {
    this.range = range;
    return this;
  }
  ...
  public ProductFacetsPriceRangesInner count(@javax.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProductFacetsPriceRangesInner productFacetsPriceRangesInner = (ProductFacetsPriceRangesInner) o;
    return Objects.equals(this.range, productFacetsPriceRangesInner.range) &&
        Objects.equals(this.count, productFacetsPriceRangesInner.count);
  }

  @Override
  public int hashCode() {
    return Objects.hash(range, count);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("range", "count"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProductFacetsPriceRangesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProductFacetsPriceRangesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProductFacetsPriceRangesInner is not found in the empty JSON string", ProductFacetsPriceRangesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProductFacetsPriceRangesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ProductFacetsPriceRangesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductFacetsPriceRangesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductFacetsPriceRangesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductFacetsPriceRangesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductFacetsPriceRangesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductFacetsPriceRangesInner>() {
           @Override
           public void write(JsonWriter out, ProductFacetsPriceRangesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProductFacetsPriceRangesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProductFacetsPriceRangesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProductFacetsPriceRangesInner
   * @throws IOException if the JSON string is invalid with respect to ProductFacetsPriceRangesInner
   */
  public static ProductFacetsPriceRangesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductFacetsPriceRangesInner.class);
  }

  /**
   * Convert an instance of ProductFacetsPriceRangesInner to an JSON string
   *
   * @return JSON string
   */
