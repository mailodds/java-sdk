...
public class RetryJob200Response {
  ...
  public RetryJob200Response() {
  }

  public RetryJob200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public RetryJob200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public RetryJob200Response job(@javax.annotation.Nullable Object job) {
    this.job = job;
    return this;
  }
  ...
  public RetryJob200Response pendingCount(@javax.annotation.Nullable Integer pendingCount) {
  ...
  public boolean equals(Object o) {
    ...
    RetryJob200Response retryJob200Response = (RetryJob200Response) o;
    return Objects.equals(this.schemaVersion, retryJob200Response.schemaVersion) &&
        Objects.equals(this.requestId, retryJob200Response.requestId) &&
        Objects.equals(this.job, retryJob200Response.job) &&
        Objects.equals(this.pendingCount, retryJob200Response.pendingCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, job, pendingCount);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "job", "pending_count"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetryJob200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetryJob200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RetryJob200Response is not found in the empty JSON string", RetryJob200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetryJob200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RetryJob200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetryJob200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetryJob200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetryJob200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetryJob200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<RetryJob200Response>() {
           @Override
           public void write(JsonWriter out, RetryJob200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetryJob200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetryJob200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetryJob200Response
   * @throws IOException if the JSON string is invalid with respect to RetryJob200Response
   */
  public static RetryJob200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetryJob200Response.class);
  }

  /**
   * Convert an instance of RetryJob200Response to an JSON string
   *
   * @return JSON string
   */
