...
import com.mailodds.models.SendingDomainDnsRecordsNs;
...
public class SendingDomainDnsRecords {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendingDomainDnsRecords.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SendingDomainDnsRecords` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
