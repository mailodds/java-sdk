...
public class ListInboundMessages200Response {
  ...
  public ListInboundMessages200Response() {
  }

  public ListInboundMessages200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public ListInboundMessages200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public ListInboundMessages200Response messages(@javax.annotation.Nullable List<Object> messages) {
    this.messages = messages;
    return this;
  }

  public ListInboundMessages200Response addMessagesItem(Object messagesItem) {
  ...
  public ListInboundMessages200Response total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ListInboundMessages200Response page(@javax.annotation.Nullable Integer page) {
    this.page = page;
    return this;
  }
  ...
  public ListInboundMessages200Response perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ListInboundMessages200Response pages(@javax.annotation.Nullable Integer pages) {
    this.pages = pages;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListInboundMessages200Response listInboundMessages200Response = (ListInboundMessages200Response) o;
    return Objects.equals(this.schemaVersion, listInboundMessages200Response.schemaVersion) &&
        Objects.equals(this.requestId, listInboundMessages200Response.requestId) &&
        Objects.equals(this.messages, listInboundMessages200Response.messages) &&
        Objects.equals(this.total, listInboundMessages200Response.total) &&
        Objects.equals(this.page, listInboundMessages200Response.page) &&
        Objects.equals(this.perPage, listInboundMessages200Response.perPage) &&
        Objects.equals(this.pages, listInboundMessages200Response.pages);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, messages, total, page, perPage, pages);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "messages", "total", "page", "per_page", "pages"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListInboundMessages200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListInboundMessages200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListInboundMessages200Response is not found in the empty JSON string", ListInboundMessages200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListInboundMessages200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListInboundMessages200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListInboundMessages200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListInboundMessages200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListInboundMessages200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListInboundMessages200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ListInboundMessages200Response>() {
           @Override
           public void write(JsonWriter out, ListInboundMessages200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListInboundMessages200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListInboundMessages200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListInboundMessages200Response
   * @throws IOException if the JSON string is invalid with respect to ListInboundMessages200Response
   */
  public static ListInboundMessages200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListInboundMessages200Response.class);
  }

  /**
   * Convert an instance of ListInboundMessages200Response to an JSON string
   *
   * @return JSON string
   */
