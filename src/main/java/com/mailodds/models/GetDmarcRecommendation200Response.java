...
import com.mailodds.models.GetDmarcRecommendation200ResponseRecommendation;
...
public class GetDmarcRecommendation200Response {
  ...
  @javax.annotation.Nullable
  private GetDmarcRecommendation200ResponseRecommendation recommendation;

  public GetDmarcRecommendation200Response() {
  }

  public GetDmarcRecommendation200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetDmarcRecommendation200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetDmarcRecommendation200Response recommendation(@javax.annotation.Nullable GetDmarcRecommendation200ResponseRecommendation recommendation) {
   ...
   */
  @javax.annotation.Nullable
  public GetDmarcRecommendation200ResponseRecommendation getRecommendation() {
    return recommendation;
  }

  public void setRecommendation(@javax.annotation.Nullable GetDmarcRecommendation200ResponseRecommendation recommendation) {
    this.recommendation = recommendation;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDmarcRecommendation200Response getDmarcRecommendation200Response = (GetDmarcRecommendation200Response) o;
    return Objects.equals(this.schemaVersion, getDmarcRecommendation200Response.schemaVersion) &&
        Objects.equals(this.requestId, getDmarcRecommendation200Response.requestId) &&
        Objects.equals(this.recommendation, getDmarcRecommendation200Response.recommendation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, recommendation);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "recommendation"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDmarcRecommendation200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDmarcRecommendation200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetDmarcRecommendation200Response is not found in the empty JSON string", GetDmarcRecommendation200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDmarcRecommendation200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDmarcRecommendation200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("recommendation") != null && !jsonObj.get("recommendation").isJsonNull()) {
        GetDmarcRecommendation200ResponseRecommendation.validateJsonElement(jsonObj.get("recommendation"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDmarcRecommendation200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDmarcRecommendation200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDmarcRecommendation200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDmarcRecommendation200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDmarcRecommendation200Response>() {
           @Override
           public void write(JsonWriter out, GetDmarcRecommendation200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDmarcRecommendation200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDmarcRecommendation200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDmarcRecommendation200Response
   * @throws IOException if the JSON string is invalid with respect to GetDmarcRecommendation200Response
   */
  public static GetDmarcRecommendation200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDmarcRecommendation200Response.class);
  }

  /**
   * Convert an instance of GetDmarcRecommendation200Response to an JSON string
   *
   * @return JSON string
   */
