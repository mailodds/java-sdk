...
import com.mailodds.models.GetCampaignAttribution200ResponseAttribution;
...
public class GetCampaignAttribution200Response {
  ...
  @javax.annotation.Nullable
  private GetCampaignAttribution200ResponseAttribution attribution;

  public GetCampaignAttribution200Response() {
  }

  public GetCampaignAttribution200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetCampaignAttribution200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetCampaignAttribution200Response campaignId(@javax.annotation.Nullable String campaignId) {
  ...
  public GetCampaignAttribution200Response attribution(@javax.annotation.Nullable GetCampaignAttribution200ResponseAttribution attribution) {
   ...
   */
  @javax.annotation.Nullable
  public GetCampaignAttribution200ResponseAttribution getAttribution() {
    return attribution;
  }

  public void setAttribution(@javax.annotation.Nullable GetCampaignAttribution200ResponseAttribution attribution) {
    this.attribution = attribution;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetCampaignAttribution200Response getCampaignAttribution200Response = (GetCampaignAttribution200Response) o;
    return Objects.equals(this.schemaVersion, getCampaignAttribution200Response.schemaVersion) &&
        Objects.equals(this.requestId, getCampaignAttribution200Response.requestId) &&
        Objects.equals(this.campaignId, getCampaignAttribution200Response.campaignId) &&
        Objects.equals(this.attribution, getCampaignAttribution200Response.attribution);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, campaignId, attribution);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "campaign_id", "attribution"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCampaignAttribution200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCampaignAttribution200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetCampaignAttribution200Response is not found in the empty JSON string", GetCampaignAttribution200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCampaignAttribution200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetCampaignAttribution200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("attribution") != null && !jsonObj.get("attribution").isJsonNull()) {
        GetCampaignAttribution200ResponseAttribution.validateJsonElement(jsonObj.get("attribution"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCampaignAttribution200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCampaignAttribution200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCampaignAttribution200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCampaignAttribution200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCampaignAttribution200Response>() {
           @Override
           public void write(JsonWriter out, GetCampaignAttribution200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCampaignAttribution200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCampaignAttribution200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCampaignAttribution200Response
   * @throws IOException if the JSON string is invalid with respect to GetCampaignAttribution200Response
   */
  public static GetCampaignAttribution200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCampaignAttribution200Response.class);
  }

  /**
   * Convert an instance of GetCampaignAttribution200Response to an JSON string
   *
   * @return JSON string
   */
