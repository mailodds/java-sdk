...
import com.mailodds.models.AlertRule;
...
public class ListAlertRules200Response {
  ...
  public ListAlertRules200Response() {
  }

  public ListAlertRules200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public ListAlertRules200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public ListAlertRules200Response rules(@javax.annotation.Nullable List<AlertRule> rules) {
    this.rules = rules;
    return this;
  }

  public ListAlertRules200Response addRulesItem(AlertRule rulesItem) {
    if (this.rules == null) {
  ...
  public void setRules(@javax.annotation.Nullable List<AlertRule> rules) {
    this.rules = rules;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListAlertRules200Response listAlertRules200Response = (ListAlertRules200Response) o;
    return Objects.equals(this.schemaVersion, listAlertRules200Response.schemaVersion) &&
        Objects.equals(this.requestId, listAlertRules200Response.requestId) &&
        Objects.equals(this.rules, listAlertRules200Response.rules);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, rules);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "rules"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAlertRules200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAlertRules200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListAlertRules200Response is not found in the empty JSON string", ListAlertRules200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAlertRules200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListAlertRules200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("rules") != null && !jsonObj.get("rules").isJsonNull()) {
        ...
        if (jsonArrayrules != null) {
          ...
          for (int i = 0; i < jsonArrayrules.size(); i++) {
            AlertRule.validateJsonElement(jsonArrayrules.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAlertRules200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAlertRules200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAlertRules200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAlertRules200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAlertRules200Response>() {
           @Override
           public void write(JsonWriter out, ListAlertRules200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAlertRules200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAlertRules200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAlertRules200Response
   * @throws IOException if the JSON string is invalid with respect to ListAlertRules200Response
   */
  public static ListAlertRules200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAlertRules200Response.class);
  }

  /**
   * Convert an instance of ListAlertRules200Response to an JSON string
   *
   * @return JSON string
   */
