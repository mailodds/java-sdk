...
public class AddBlacklistMonitorRequest {
  ...
  public AddBlacklistMonitorRequest() {
  }

  public AddBlacklistMonitorRequest target(@javax.annotation.Nonnull String target) {
    this.target = target;
    return this;
  }
  ...
  public AddBlacklistMonitorRequest targetType(@javax.annotation.Nonnull TargetTypeEnum targetType) {
  ...
  public boolean equals(Object o) {
    ...
    AddBlacklistMonitorRequest addBlacklistMonitorRequest = (AddBlacklistMonitorRequest) o;
    return Objects.equals(this.target, addBlacklistMonitorRequest.target) &&
        Objects.equals(this.targetType, addBlacklistMonitorRequest.targetType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(target, targetType);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("target", "target_type"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("target", "target_type"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddBlacklistMonitorRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddBlacklistMonitorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AddBlacklistMonitorRequest is not found in the empty JSON string", AddBlacklistMonitorRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddBlacklistMonitorRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddBlacklistMonitorRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddBlacklistMonitorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddBlacklistMonitorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddBlacklistMonitorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddBlacklistMonitorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddBlacklistMonitorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddBlacklistMonitorRequest>() {
           @Override
           public void write(JsonWriter out, AddBlacklistMonitorRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddBlacklistMonitorRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddBlacklistMonitorRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddBlacklistMonitorRequest
   * @throws IOException if the JSON string is invalid with respect to AddBlacklistMonitorRequest
   */
  public static AddBlacklistMonitorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddBlacklistMonitorRequest.class);
  }

  /**
   * Convert an instance of AddBlacklistMonitorRequest to an JSON string
   *
   * @return JSON string
   */
