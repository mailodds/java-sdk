...
import com.mailodds.models.DmarcDomain;
...
public class ListDmarcDomains200Response {
  ...
  @javax.annotation.Nullable
  private List<DmarcDomain> domains = new ArrayList<>();

  public ListDmarcDomains200Response() {
  }

  public ListDmarcDomains200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public ListDmarcDomains200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public ListDmarcDomains200Response domains(@javax.annotation.Nullable List<DmarcDomain> domains) {
    this.domains = domains;
    return this;
  }

  public ListDmarcDomains200Response addDomainsItem(DmarcDomain domainsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<DmarcDomain> getDomains() {
    return domains;
  }

  public void setDomains(@javax.annotation.Nullable List<DmarcDomain> domains) {
    this.domains = domains;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListDmarcDomains200Response listDmarcDomains200Response = (ListDmarcDomains200Response) o;
    return Objects.equals(this.schemaVersion, listDmarcDomains200Response.schemaVersion) &&
        Objects.equals(this.requestId, listDmarcDomains200Response.requestId) &&
        Objects.equals(this.domains, listDmarcDomains200Response.domains);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, domains);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "domains"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListDmarcDomains200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListDmarcDomains200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListDmarcDomains200Response is not found in the empty JSON string", ListDmarcDomains200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListDmarcDomains200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListDmarcDomains200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("domains") != null && !jsonObj.get("domains").isJsonNull()) {
        ...
        if (jsonArraydomains != null) {
          ...
          for (int i = 0; i < jsonArraydomains.size(); i++) {
            DmarcDomain.validateJsonElement(jsonArraydomains.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListDmarcDomains200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListDmarcDomains200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListDmarcDomains200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListDmarcDomains200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ListDmarcDomains200Response>() {
           @Override
           public void write(JsonWriter out, ListDmarcDomains200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListDmarcDomains200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListDmarcDomains200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListDmarcDomains200Response
   * @throws IOException if the JSON string is invalid with respect to ListDmarcDomains200Response
   */
  public static ListDmarcDomains200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListDmarcDomains200Response.class);
  }

  /**
   * Convert an instance of ListDmarcDomains200Response to an JSON string
   *
   * @return JSON string
   */
