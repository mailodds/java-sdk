...
import com.mailodds.models.GetReputationTimeline200ResponseTimelineTimelineInner;
...
public class GetReputationTimeline200ResponseTimeline {
  ...
  @javax.annotation.Nullable
  private List<GetReputationTimeline200ResponseTimelineTimelineInner> timeline = new ArrayList<>();

  public GetReputationTimeline200ResponseTimeline() {
  }

  public GetReputationTimeline200ResponseTimeline period(@javax.annotation.Nullable PeriodEnum period) {
    this.period = period;
    return this;
  }
  ...
  public GetReputationTimeline200ResponseTimeline timeline(@javax.annotation.Nullable List<GetReputationTimeline200ResponseTimelineTimelineInner> timeline) {
    this.timeline = timeline;
    return this;
  }

  public GetReputationTimeline200ResponseTimeline addTimelineItem(GetReputationTimeline200ResponseTimelineTimelineInner timelineItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GetReputationTimeline200ResponseTimelineTimelineInner> getTimeline() {
    return timeline;
  }

  public void setTimeline(@javax.annotation.Nullable List<GetReputationTimeline200ResponseTimelineTimelineInner> timeline) {
    this.timeline = timeline;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetReputationTimeline200ResponseTimeline getReputationTimeline200ResponseTimeline = (GetReputationTimeline200ResponseTimeline) o;
    return Objects.equals(this.period, getReputationTimeline200ResponseTimeline.period) &&
        Objects.equals(this.timeline, getReputationTimeline200ResponseTimeline.timeline);
  }

  @Override
  public int hashCode() {
    return Objects.hash(period, timeline);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("period", "timeline"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetReputationTimeline200ResponseTimeline
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetReputationTimeline200ResponseTimeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetReputationTimeline200ResponseTimeline is not found in the empty JSON string", GetReputationTimeline200ResponseTimeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetReputationTimeline200ResponseTimeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetReputationTimeline200ResponseTimeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("timeline") != null && !jsonObj.get("timeline").isJsonNull()) {
        ...
        if (jsonArraytimeline != null) {
          ...
          if (!jsonObj.get("timeline").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `timeline` to be an array in the JSON string but got `%s`", jsonObj.get("timeline").toString()));
          }

          // validate the optional field `timeline` (array)
          for (int i = 0; i < jsonArraytimeline.size(); i++) {
            GetReputationTimeline200ResponseTimelineTimelineInner.validateJsonElement(jsonArraytimeline.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetReputationTimeline200ResponseTimeline.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetReputationTimeline200ResponseTimeline' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetReputationTimeline200ResponseTimeline> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetReputationTimeline200ResponseTimeline.class));

       return (TypeAdapter<T>) new TypeAdapter<GetReputationTimeline200ResponseTimeline>() {
           @Override
           public void write(JsonWriter out, GetReputationTimeline200ResponseTimeline value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetReputationTimeline200ResponseTimeline read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetReputationTimeline200ResponseTimeline given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetReputationTimeline200ResponseTimeline
   * @throws IOException if the JSON string is invalid with respect to GetReputationTimeline200ResponseTimeline
   */
  public static GetReputationTimeline200ResponseTimeline fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetReputationTimeline200ResponseTimeline.class);
  }

  /**
   * Convert an instance of GetReputationTimeline200ResponseTimeline to an JSON string
   *
   * @return JSON string
   */
