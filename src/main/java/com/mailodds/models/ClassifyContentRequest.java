...
public class ClassifyContentRequest {
  ...
  public ClassifyContentRequest subject(@javax.annotation.Nullable String subject) {
  ...
  public ClassifyContentRequest htmlBody(@javax.annotation.Nullable String htmlBody) {
  ...
  public ClassifyContentRequest content(@javax.annotation.Nullable String content) {
  ...
  public boolean equals(Object o) {
    ...
    ClassifyContentRequest classifyContentRequest = (ClassifyContentRequest) o;
    return Objects.equals(this.subject, classifyContentRequest.subject) &&
        Objects.equals(this.htmlBody, classifyContentRequest.htmlBody) &&
        Objects.equals(this.content, classifyContentRequest.content);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subject, htmlBody, content);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("subject", "html_body", "content"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ClassifyContentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClassifyContentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ClassifyContentRequest is not found in the empty JSON string", ClassifyContentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClassifyContentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ClassifyContentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClassifyContentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClassifyContentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClassifyContentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClassifyContentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ClassifyContentRequest>() {
           @Override
           public void write(JsonWriter out, ClassifyContentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ClassifyContentRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ClassifyContentRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ClassifyContentRequest
   * @throws IOException if the JSON string is invalid with respect to ClassifyContentRequest
   */
  public static ClassifyContentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClassifyContentRequest.class);
  }

  /**
   * Convert an instance of ClassifyContentRequest to an JSON string
   *
   * @return JSON string
   */
