...
import com.mailodds.models.GetBlacklistHistory200ResponseChecksInner;
...
public class GetBlacklistHistory200Response {
  ...
  @javax.annotation.Nullable
  private List<GetBlacklistHistory200ResponseChecksInner> checks = new ArrayList<>();
  ...
  public GetBlacklistHistory200Response() {
  }

  public GetBlacklistHistory200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetBlacklistHistory200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetBlacklistHistory200Response checks(@javax.annotation.Nullable List<GetBlacklistHistory200ResponseChecksInner> checks) {
    this.checks = checks;
    return this;
  }

  public GetBlacklistHistory200Response addChecksItem(GetBlacklistHistory200ResponseChecksInner checksItem) {
    if (this.checks == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<GetBlacklistHistory200ResponseChecksInner> getChecks() {
    return checks;
  }

  public void setChecks(@javax.annotation.Nullable List<GetBlacklistHistory200ResponseChecksInner> checks) {
    this.checks = checks;
  }


  public GetBlacklistHistory200Response pagination(@javax.annotation.Nullable Pagination pagination) {
  ...
  public boolean equals(Object o) {
    ...
    GetBlacklistHistory200Response getBlacklistHistory200Response = (GetBlacklistHistory200Response) o;
    return Objects.equals(this.schemaVersion, getBlacklistHistory200Response.schemaVersion) &&
        Objects.equals(this.requestId, getBlacklistHistory200Response.requestId) &&
        Objects.equals(this.checks, getBlacklistHistory200Response.checks) &&
        Objects.equals(this.pagination, getBlacklistHistory200Response.pagination);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, checks, pagination);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "checks", "pagination"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBlacklistHistory200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBlacklistHistory200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetBlacklistHistory200Response is not found in the empty JSON string", GetBlacklistHistory200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBlacklistHistory200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetBlacklistHistory200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("checks") != null && !jsonObj.get("checks").isJsonNull()) {
        ...
        if (jsonArraychecks != null) {
          ...
          for (int i = 0; i < jsonArraychecks.size(); i++) {
            GetBlacklistHistory200ResponseChecksInner.validateJsonElement(jsonArraychecks.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBlacklistHistory200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBlacklistHistory200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBlacklistHistory200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBlacklistHistory200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBlacklistHistory200Response>() {
           @Override
           public void write(JsonWriter out, GetBlacklistHistory200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBlacklistHistory200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBlacklistHistory200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBlacklistHistory200Response
   * @throws IOException if the JSON string is invalid with respect to GetBlacklistHistory200Response
   */
  public static GetBlacklistHistory200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBlacklistHistory200Response.class);
  }

  /**
   * Convert an instance of GetBlacklistHistory200Response to an JSON string
   *
   * @return JSON string
   */
