...
public class GetInboundMessage200Response {
  ...
  public GetInboundMessage200Response() {
  }

  public GetInboundMessage200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetInboundMessage200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetInboundMessage200Response message(@javax.annotation.Nullable Object message) {
  ...
  public boolean equals(Object o) {
    ...
    GetInboundMessage200Response getInboundMessage200Response = (GetInboundMessage200Response) o;
    return Objects.equals(this.schemaVersion, getInboundMessage200Response.schemaVersion) &&
        Objects.equals(this.requestId, getInboundMessage200Response.requestId) &&
        Objects.equals(this.message, getInboundMessage200Response.message);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, message);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "message"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetInboundMessage200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetInboundMessage200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetInboundMessage200Response is not found in the empty JSON string", GetInboundMessage200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetInboundMessage200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetInboundMessage200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetInboundMessage200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetInboundMessage200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetInboundMessage200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetInboundMessage200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetInboundMessage200Response>() {
           @Override
           public void write(JsonWriter out, GetInboundMessage200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetInboundMessage200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetInboundMessage200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetInboundMessage200Response
   * @throws IOException if the JSON string is invalid with respect to GetInboundMessage200Response
   */
  public static GetInboundMessage200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetInboundMessage200Response.class);
  }

  /**
   * Convert an instance of GetInboundMessage200Response to an JSON string
   *
   * @return JSON string
   */
