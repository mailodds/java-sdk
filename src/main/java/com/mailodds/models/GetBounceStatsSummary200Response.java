...
public class GetBounceStatsSummary200Response {
  ...
  public GetBounceStatsSummary200Response() {
  }

  public GetBounceStatsSummary200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetBounceStatsSummary200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetBounceStatsSummary200Response summary(@javax.annotation.Nullable Object summary) {
  ...
  public boolean equals(Object o) {
    ...
    GetBounceStatsSummary200Response getBounceStatsSummary200Response = (GetBounceStatsSummary200Response) o;
    return Objects.equals(this.schemaVersion, getBounceStatsSummary200Response.schemaVersion) &&
        Objects.equals(this.requestId, getBounceStatsSummary200Response.requestId) &&
        Objects.equals(this.summary, getBounceStatsSummary200Response.summary);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, summary);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "summary"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBounceStatsSummary200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBounceStatsSummary200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetBounceStatsSummary200Response is not found in the empty JSON string", GetBounceStatsSummary200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBounceStatsSummary200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetBounceStatsSummary200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBounceStatsSummary200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBounceStatsSummary200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBounceStatsSummary200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBounceStatsSummary200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBounceStatsSummary200Response>() {
           @Override
           public void write(JsonWriter out, GetBounceStatsSummary200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBounceStatsSummary200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBounceStatsSummary200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBounceStatsSummary200Response
   * @throws IOException if the JSON string is invalid with respect to GetBounceStatsSummary200Response
   */
  public static GetBounceStatsSummary200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBounceStatsSummary200Response.class);
  }

  /**
   * Convert an instance of GetBounceStatsSummary200Response to an JSON string
   *
   * @return JSON string
   */
