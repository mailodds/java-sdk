...
public class RunSpamCheck201Response {
  ...
  public static final String SERIALIZED_NAME_SPAM_CHECK = "spam_check";
  @SerializedName(SERIALIZED_NAME_SPAM_CHECK)
  @javax.annotation.Nullable
  private SpamCheck spamCheck;

  public RunSpamCheck201Response() {
  }

  public RunSpamCheck201Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public RunSpamCheck201Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public RunSpamCheck201Response spamCheck(@javax.annotation.Nullable SpamCheck spamCheck) {
  ...
  public void setSpamCheck(@javax.annotation.Nullable SpamCheck spamCheck) {
    this.spamCheck = spamCheck;
  }
  ...
  public boolean equals(Object o) {
    ...
    RunSpamCheck201Response runSpamCheck201Response = (RunSpamCheck201Response) o;
    return Objects.equals(this.schemaVersion, runSpamCheck201Response.schemaVersion) &&
        Objects.equals(this.requestId, runSpamCheck201Response.requestId) &&
        Objects.equals(this.spamCheck, runSpamCheck201Response.spamCheck);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, spamCheck);
  }
  ...
  public String toString() {
    ...
    sb.append("    spamCheck: ").append(toIndentedString(spamCheck)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "spam_check"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RunSpamCheck201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunSpamCheck201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RunSpamCheck201Response is not found in the empty JSON string", RunSpamCheck201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunSpamCheck201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RunSpamCheck201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `spam_check`
      if (jsonObj.get("spam_check") != null && !jsonObj.get("spam_check").isJsonNull()) {
        SpamCheck.validateJsonElement(jsonObj.get("spam_check"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RunSpamCheck201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RunSpamCheck201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RunSpamCheck201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RunSpamCheck201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<RunSpamCheck201Response>() {
           @Override
           public void write(JsonWriter out, RunSpamCheck201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RunSpamCheck201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RunSpamCheck201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RunSpamCheck201Response
   * @throws IOException if the JSON string is invalid with respect to RunSpamCheck201Response
   */
  public static RunSpamCheck201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RunSpamCheck201Response.class);
  }

  /**
   * Convert an instance of RunSpamCheck201Response to an JSON string
   *
   * @return JSON string
   */
