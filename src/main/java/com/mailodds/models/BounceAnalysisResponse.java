...
import com.mailodds.models.BounceAnalysisResponseAnalysis;
...
public class BounceAnalysisResponse {
  ...
  @javax.annotation.Nullable
  private BounceAnalysisResponseAnalysis analysis;

  public BounceAnalysisResponse() {
  }

  public BounceAnalysisResponse schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public BounceAnalysisResponse requestId(@javax.annotation.Nullable String requestId) {
  ...
  public BounceAnalysisResponse analysis(@javax.annotation.Nullable BounceAnalysisResponseAnalysis analysis) {
   ...
   */
  @javax.annotation.Nullable
  public BounceAnalysisResponseAnalysis getAnalysis() {
    return analysis;
  }

  public void setAnalysis(@javax.annotation.Nullable BounceAnalysisResponseAnalysis analysis) {
    this.analysis = analysis;
  }
  ...
  public boolean equals(Object o) {
    ...
    BounceAnalysisResponse bounceAnalysisResponse = (BounceAnalysisResponse) o;
    return Objects.equals(this.schemaVersion, bounceAnalysisResponse.schemaVersion) &&
        Objects.equals(this.requestId, bounceAnalysisResponse.requestId) &&
        Objects.equals(this.analysis, bounceAnalysisResponse.analysis);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, analysis);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "analysis"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to BounceAnalysisResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BounceAnalysisResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BounceAnalysisResponse is not found in the empty JSON string", BounceAnalysisResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BounceAnalysisResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BounceAnalysisResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("analysis") != null && !jsonObj.get("analysis").isJsonNull()) {
        BounceAnalysisResponseAnalysis.validateJsonElement(jsonObj.get("analysis"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BounceAnalysisResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BounceAnalysisResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BounceAnalysisResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BounceAnalysisResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BounceAnalysisResponse>() {
           @Override
           public void write(JsonWriter out, BounceAnalysisResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BounceAnalysisResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BounceAnalysisResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BounceAnalysisResponse
   * @throws IOException if the JSON string is invalid with respect to BounceAnalysisResponse
   */
  public static BounceAnalysisResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BounceAnalysisResponse.class);
  }

  /**
   * Convert an instance of BounceAnalysisResponse to an JSON string
   *
   * @return JSON string
   */
