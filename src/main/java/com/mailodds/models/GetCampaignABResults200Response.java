...
import com.mailodds.models.GetCampaignABResults200ResponseVariantsInner;
import com.mailodds.models.GetCampaignABResults200ResponseWinner;
...
public class GetCampaignABResults200Response {
  ...
  @javax.annotation.Nullable
  private List<GetCampaignABResults200ResponseVariantsInner> variants = new ArrayList<>();

  public static final String SERIALIZED_NAME_WINNER = "winner";
  @SerializedName(SERIALIZED_NAME_WINNER)
  @javax.annotation.Nullable
  private GetCampaignABResults200ResponseWinner winner;

  public GetCampaignABResults200Response() {
  }

  public GetCampaignABResults200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetCampaignABResults200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetCampaignABResults200Response campaignId(@javax.annotation.Nullable String campaignId) {
  ...
  public GetCampaignABResults200Response variants(@javax.annotation.Nullable List<GetCampaignABResults200ResponseVariantsInner> variants) {
    this.variants = variants;
    return this;
  }

  public GetCampaignABResults200Response addVariantsItem(GetCampaignABResults200ResponseVariantsInner variantsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GetCampaignABResults200ResponseVariantsInner> getVariants() {
    return variants;
  }

  public void setVariants(@javax.annotation.Nullable List<GetCampaignABResults200ResponseVariantsInner> variants) {
    this.variants = variants;
  }


  public GetCampaignABResults200Response winner(@javax.annotation.Nullable GetCampaignABResults200ResponseWinner winner) {
    this.winner = winner;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public GetCampaignABResults200ResponseWinner getWinner() {
    return winner;
  }

  public void setWinner(@javax.annotation.Nullable GetCampaignABResults200ResponseWinner winner) {
    this.winner = winner;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetCampaignABResults200Response getCampaignABResults200Response = (GetCampaignABResults200Response) o;
    return Objects.equals(this.schemaVersion, getCampaignABResults200Response.schemaVersion) &&
        Objects.equals(this.requestId, getCampaignABResults200Response.requestId) &&
        Objects.equals(this.campaignId, getCampaignABResults200Response.campaignId) &&
        Objects.equals(this.variants, getCampaignABResults200Response.variants) &&
        Objects.equals(this.winner, getCampaignABResults200Response.winner);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, campaignId, variants, winner);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "campaign_id", "variants", "winner"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCampaignABResults200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCampaignABResults200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetCampaignABResults200Response is not found in the empty JSON string", GetCampaignABResults200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCampaignABResults200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetCampaignABResults200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("variants") != null && !jsonObj.get("variants").isJsonNull()) {
        ...
        if (jsonArrayvariants != null) {
          ...
          for (int i = 0; i < jsonArrayvariants.size(); i++) {
            GetCampaignABResults200ResponseVariantsInner.validateJsonElement(jsonArrayvariants.get(i));
          };
        }
      }
      // validate the optional field `winner`
      if (jsonObj.get("winner") != null && !jsonObj.get("winner").isJsonNull()) {
        GetCampaignABResults200ResponseWinner.validateJsonElement(jsonObj.get("winner"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCampaignABResults200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCampaignABResults200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCampaignABResults200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCampaignABResults200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCampaignABResults200Response>() {
           @Override
           public void write(JsonWriter out, GetCampaignABResults200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCampaignABResults200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCampaignABResults200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCampaignABResults200Response
   * @throws IOException if the JSON string is invalid with respect to GetCampaignABResults200Response
   */
  public static GetCampaignABResults200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCampaignABResults200Response.class);
  }

  /**
   * Convert an instance of GetCampaignABResults200Response to an JSON string
   *
   * @return JSON string
   */
