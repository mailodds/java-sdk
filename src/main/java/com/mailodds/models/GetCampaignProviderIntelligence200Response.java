...
import com.mailodds.models.GetCampaignProviderIntelligence200ResponseProvidersInner;
...
public class GetCampaignProviderIntelligence200Response {
  ...
  @javax.annotation.Nullable
  private List<GetCampaignProviderIntelligence200ResponseProvidersInner> providers = new ArrayList<>();

  public GetCampaignProviderIntelligence200Response() {
  }

  public GetCampaignProviderIntelligence200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetCampaignProviderIntelligence200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetCampaignProviderIntelligence200Response campaignId(@javax.annotation.Nullable String campaignId) {
  ...
  public GetCampaignProviderIntelligence200Response providers(@javax.annotation.Nullable List<GetCampaignProviderIntelligence200ResponseProvidersInner> providers) {
    this.providers = providers;
    return this;
  }

  public GetCampaignProviderIntelligence200Response addProvidersItem(GetCampaignProviderIntelligence200ResponseProvidersInner providersItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GetCampaignProviderIntelligence200ResponseProvidersInner> getProviders() {
    return providers;
  }

  public void setProviders(@javax.annotation.Nullable List<GetCampaignProviderIntelligence200ResponseProvidersInner> providers) {
    this.providers = providers;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetCampaignProviderIntelligence200Response getCampaignProviderIntelligence200Response = (GetCampaignProviderIntelligence200Response) o;
    return Objects.equals(this.schemaVersion, getCampaignProviderIntelligence200Response.schemaVersion) &&
        Objects.equals(this.requestId, getCampaignProviderIntelligence200Response.requestId) &&
        Objects.equals(this.campaignId, getCampaignProviderIntelligence200Response.campaignId) &&
        Objects.equals(this.providers, getCampaignProviderIntelligence200Response.providers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, campaignId, providers);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "campaign_id", "providers"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCampaignProviderIntelligence200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCampaignProviderIntelligence200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetCampaignProviderIntelligence200Response is not found in the empty JSON string", GetCampaignProviderIntelligence200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCampaignProviderIntelligence200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetCampaignProviderIntelligence200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("providers") != null && !jsonObj.get("providers").isJsonNull()) {
        ...
        if (jsonArrayproviders != null) {
          ...
          for (int i = 0; i < jsonArrayproviders.size(); i++) {
            GetCampaignProviderIntelligence200ResponseProvidersInner.validateJsonElement(jsonArrayproviders.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCampaignProviderIntelligence200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCampaignProviderIntelligence200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCampaignProviderIntelligence200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCampaignProviderIntelligence200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCampaignProviderIntelligence200Response>() {
           @Override
           public void write(JsonWriter out, GetCampaignProviderIntelligence200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetCampaignProviderIntelligence200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetCampaignProviderIntelligence200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCampaignProviderIntelligence200Response
   * @throws IOException if the JSON string is invalid with respect to GetCampaignProviderIntelligence200Response
   */
  public static GetCampaignProviderIntelligence200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCampaignProviderIntelligence200Response.class);
  }

  /**
   * Convert an instance of GetCampaignProviderIntelligence200Response to an JSON string
   *
   * @return JSON string
   */
