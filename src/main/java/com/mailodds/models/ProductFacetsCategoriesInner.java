...
public class ProductFacetsCategoriesInner {
  ...
  public ProductFacetsCategoriesInner() {
  }

  public ProductFacetsCategoriesInner name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductFacetsCategoriesInner count(@javax.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProductFacetsCategoriesInner productFacetsCategoriesInner = (ProductFacetsCategoriesInner) o;
    return Objects.equals(this.name, productFacetsCategoriesInner.name) &&
        Objects.equals(this.count, productFacetsCategoriesInner.count);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "count"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProductFacetsCategoriesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProductFacetsCategoriesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProductFacetsCategoriesInner is not found in the empty JSON string", ProductFacetsCategoriesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProductFacetsCategoriesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ProductFacetsCategoriesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductFacetsCategoriesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductFacetsCategoriesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductFacetsCategoriesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductFacetsCategoriesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductFacetsCategoriesInner>() {
           @Override
           public void write(JsonWriter out, ProductFacetsCategoriesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProductFacetsCategoriesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProductFacetsCategoriesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProductFacetsCategoriesInner
   * @throws IOException if the JSON string is invalid with respect to ProductFacetsCategoriesInner
   */
  public static ProductFacetsCategoriesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductFacetsCategoriesInner.class);
  }

  /**
   * Convert an instance of ProductFacetsCategoriesInner to an JSON string
   *
   * @return JSON string
   */
