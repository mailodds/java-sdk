...
import com.mailodds.models.GetDmarcDomain200ResponseDomain;
...
public class GetDmarcDomain200Response {
  ...
  @javax.annotation.Nullable
  private GetDmarcDomain200ResponseDomain domain;

  public GetDmarcDomain200Response() {
  }

  public GetDmarcDomain200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetDmarcDomain200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetDmarcDomain200Response domain(@javax.annotation.Nullable GetDmarcDomain200ResponseDomain domain) {
    this.domain = domain;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public GetDmarcDomain200ResponseDomain getDomain() {
    return domain;
  }

  public void setDomain(@javax.annotation.Nullable GetDmarcDomain200ResponseDomain domain) {
    this.domain = domain;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDmarcDomain200Response getDmarcDomain200Response = (GetDmarcDomain200Response) o;
    return Objects.equals(this.schemaVersion, getDmarcDomain200Response.schemaVersion) &&
        Objects.equals(this.requestId, getDmarcDomain200Response.requestId) &&
        Objects.equals(this.domain, getDmarcDomain200Response.domain);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, domain);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "domain"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDmarcDomain200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDmarcDomain200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetDmarcDomain200Response is not found in the empty JSON string", GetDmarcDomain200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDmarcDomain200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDmarcDomain200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("domain") != null && !jsonObj.get("domain").isJsonNull()) {
        GetDmarcDomain200ResponseDomain.validateJsonElement(jsonObj.get("domain"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDmarcDomain200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDmarcDomain200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDmarcDomain200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDmarcDomain200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDmarcDomain200Response>() {
           @Override
           public void write(JsonWriter out, GetDmarcDomain200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDmarcDomain200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDmarcDomain200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDmarcDomain200Response
   * @throws IOException if the JSON string is invalid with respect to GetDmarcDomain200Response
   */
  public static GetDmarcDomain200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDmarcDomain200Response.class);
  }

  /**
   * Convert an instance of GetDmarcDomain200Response to an JSON string
   *
   * @return JSON string
   */
