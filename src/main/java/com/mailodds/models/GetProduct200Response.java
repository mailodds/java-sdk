...
public class GetProduct200Response {
  ...
  public GetProduct200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetProduct200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetProduct200Response product(@javax.annotation.Nullable StoreProduct product) {
  ...
  public void setProduct(@javax.annotation.Nullable StoreProduct product) {
    this.product = product;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.schemaVersion, getProduct200Response.schemaVersion) &&
        Objects.equals(this.requestId, getProduct200Response.requestId) &&
        Objects.equals(this.product, getProduct200Response.product);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, product);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "product"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProduct200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetProduct200Response is not found in the empty JSON string", GetProduct200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProduct200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetProduct200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("product") != null && !jsonObj.get("product").isJsonNull()) {
        StoreProduct.validateJsonElement(jsonObj.get("product"));
      }
  }
