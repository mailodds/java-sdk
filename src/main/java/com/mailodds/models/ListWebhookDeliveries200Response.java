...
import com.mailodds.models.ListWebhookDeliveries200ResponseDeliveriesInner;
...
public class ListWebhookDeliveries200Response {
  ...
  private List<ListWebhookDeliveries200ResponseDeliveriesInner> deliveries = new ArrayList<>();

  public ListWebhookDeliveries200Response() {
  }

  public ListWebhookDeliveries200Response deliveries(@javax.annotation.Nullable List<ListWebhookDeliveries200ResponseDeliveriesInner> deliveries) {
    this.deliveries = deliveries;
    return this;
  }

  public ListWebhookDeliveries200Response addDeliveriesItem(ListWebhookDeliveries200ResponseDeliveriesInner deliveriesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ListWebhookDeliveries200ResponseDeliveriesInner> getDeliveries() {
    return deliveries;
  }

  public void setDeliveries(@javax.annotation.Nullable List<ListWebhookDeliveries200ResponseDeliveriesInner> deliveries) {
    this.deliveries = deliveries;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deliveries, listWebhookDeliveries200Response.deliveries);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListWebhookDeliveries200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListWebhookDeliveries200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListWebhookDeliveries200Response is not found in the empty JSON string", ListWebhookDeliveries200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListWebhookDeliveries200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListWebhookDeliveries200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("deliveries") != null && !jsonObj.get("deliveries").isJsonNull()) {
        ...
        if (jsonArraydeliveries != null) {
          ...
          for (int i = 0; i < jsonArraydeliveries.size(); i++) {
            ListWebhookDeliveries200ResponseDeliveriesInner.validateJsonElement(jsonArraydeliveries.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListWebhookDeliveries200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListWebhookDeliveries200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListWebhookDeliveries200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListWebhookDeliveries200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ListWebhookDeliveries200Response>() {
           @Override
           public void write(JsonWriter out, ListWebhookDeliveries200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListWebhookDeliveries200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListWebhookDeliveries200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListWebhookDeliveries200Response
   * @throws IOException if the JSON string is invalid with respect to ListWebhookDeliveries200Response
   */
  public static ListWebhookDeliveries200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListWebhookDeliveries200Response.class);
  }

  /**
   * Convert an instance of ListWebhookDeliveries200Response to an JSON string
   *
   * @return JSON string
   */
