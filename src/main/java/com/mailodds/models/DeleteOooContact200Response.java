...
public class DeleteOooContact200Response {
  public static final String SERIALIZED_NAME_CLEARED = "cleared";
  @SerializedName(SERIALIZED_NAME_CLEARED)
  @javax.annotation.Nullable
  private Boolean cleared;

  public DeleteOooContact200Response() {
  }

  public DeleteOooContact200Response cleared(@javax.annotation.Nullable Boolean cleared) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteOooContact200Response deleteOooContact200Response = (DeleteOooContact200Response) o;
    return Objects.equals(this.cleared, deleteOooContact200Response.cleared);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("cleared"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteOooContact200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteOooContact200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteOooContact200Response is not found in the empty JSON string", DeleteOooContact200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteOooContact200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteOooContact200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteOooContact200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteOooContact200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteOooContact200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteOooContact200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteOooContact200Response>() {
           @Override
           public void write(JsonWriter out, DeleteOooContact200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteOooContact200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteOooContact200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteOooContact200Response
   * @throws IOException if the JSON string is invalid with respect to DeleteOooContact200Response
   */
  public static DeleteOooContact200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteOooContact200Response.class);
  }

  /**
   * Convert an instance of DeleteOooContact200Response to an JSON string
   *
   * @return JSON string
   */
