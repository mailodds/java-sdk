...
public class SuppressDisengaged200Response {
  ...
  public SuppressDisengaged200Response() {
  }

  public SuppressDisengaged200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public SuppressDisengaged200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public SuppressDisengaged200Response suppressedCount(@javax.annotation.Nullable Integer suppressedCount) {
  ...
  public SuppressDisengaged200Response dryRun(@javax.annotation.Nullable Boolean dryRun) {
    this.dryRun = dryRun;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SuppressDisengaged200Response suppressDisengaged200Response = (SuppressDisengaged200Response) o;
    return Objects.equals(this.schemaVersion, suppressDisengaged200Response.schemaVersion) &&
        Objects.equals(this.requestId, suppressDisengaged200Response.requestId) &&
        Objects.equals(this.suppressedCount, suppressDisengaged200Response.suppressedCount) &&
        Objects.equals(this.dryRun, suppressDisengaged200Response.dryRun);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, suppressedCount, dryRun);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "suppressed_count", "dry_run"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to SuppressDisengaged200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SuppressDisengaged200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SuppressDisengaged200Response is not found in the empty JSON string", SuppressDisengaged200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SuppressDisengaged200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SuppressDisengaged200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SuppressDisengaged200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SuppressDisengaged200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SuppressDisengaged200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SuppressDisengaged200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<SuppressDisengaged200Response>() {
           @Override
           public void write(JsonWriter out, SuppressDisengaged200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SuppressDisengaged200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SuppressDisengaged200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SuppressDisengaged200Response
   * @throws IOException if the JSON string is invalid with respect to SuppressDisengaged200Response
   */
  public static SuppressDisengaged200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SuppressDisengaged200Response.class);
  }

  /**
   * Convert an instance of SuppressDisengaged200Response to an JSON string
   *
   * @return JSON string
   */
