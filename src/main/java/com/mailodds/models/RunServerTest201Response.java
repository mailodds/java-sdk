...
import com.mailodds.models.ServerTest;
...
public class RunServerTest201Response {
  ...
  public RunServerTest201Response() {
  }

  public RunServerTest201Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public RunServerTest201Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public RunServerTest201Response test(@javax.annotation.Nullable ServerTest test) {
    this.test = test;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ServerTest getTest() {
    return test;
  }

  public void setTest(@javax.annotation.Nullable ServerTest test) {
    this.test = test;
  }
  ...
  public boolean equals(Object o) {
    ...
    RunServerTest201Response runServerTest201Response = (RunServerTest201Response) o;
    return Objects.equals(this.schemaVersion, runServerTest201Response.schemaVersion) &&
        Objects.equals(this.requestId, runServerTest201Response.requestId) &&
        Objects.equals(this.test, runServerTest201Response.test);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, test);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "test"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RunServerTest201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunServerTest201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RunServerTest201Response is not found in the empty JSON string", RunServerTest201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunServerTest201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RunServerTest201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("test") != null && !jsonObj.get("test").isJsonNull()) {
        ServerTest.validateJsonElement(jsonObj.get("test"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RunServerTest201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RunServerTest201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RunServerTest201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RunServerTest201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<RunServerTest201Response>() {
           @Override
           public void write(JsonWriter out, RunServerTest201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RunServerTest201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RunServerTest201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RunServerTest201Response
   * @throws IOException if the JSON string is invalid with respect to RunServerTest201Response
   */
  public static RunServerTest201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RunServerTest201Response.class);
  }

  /**
   * Convert an instance of RunServerTest201Response to an JSON string
   *
   * @return JSON string
   */
