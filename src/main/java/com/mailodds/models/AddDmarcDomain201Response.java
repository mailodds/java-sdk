...
public class AddDmarcDomain201Response {
  ...
  @javax.annotation.Nullable
  private DmarcDomain domain;

  public AddDmarcDomain201Response() {
  }

  public AddDmarcDomain201Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public AddDmarcDomain201Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public AddDmarcDomain201Response domain(@javax.annotation.Nullable DmarcDomain domain) {
    this.domain = domain;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public DmarcDomain getDomain() {
    return domain;
  }

  public void setDomain(@javax.annotation.Nullable DmarcDomain domain) {
    this.domain = domain;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddDmarcDomain201Response addDmarcDomain201Response = (AddDmarcDomain201Response) o;
    return Objects.equals(this.schemaVersion, addDmarcDomain201Response.schemaVersion) &&
        Objects.equals(this.requestId, addDmarcDomain201Response.requestId) &&
        Objects.equals(this.domain, addDmarcDomain201Response.domain);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddDmarcDomain201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddDmarcDomain201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AddDmarcDomain201Response is not found in the empty JSON string", AddDmarcDomain201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddDmarcDomain201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddDmarcDomain201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("domain") != null && !jsonObj.get("domain").isJsonNull()) {
        DmarcDomain.validateJsonElement(jsonObj.get("domain"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddDmarcDomain201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddDmarcDomain201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddDmarcDomain201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddDmarcDomain201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AddDmarcDomain201Response>() {
           @Override
           public void write(JsonWriter out, AddDmarcDomain201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddDmarcDomain201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddDmarcDomain201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddDmarcDomain201Response
   * @throws IOException if the JSON string is invalid with respect to AddDmarcDomain201Response
   */
  public static AddDmarcDomain201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddDmarcDomain201Response.class);
  }

  /**
   * Convert an instance of AddDmarcDomain201Response to an JSON string
   *
   * @return JSON string
   */
