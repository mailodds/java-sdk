...
import com.mailodds.models.CampaignVariant;
...
public class CreateCampaignVariant201Response {
  ...
  @javax.annotation.Nullable
  private CampaignVariant variant;

  public CreateCampaignVariant201Response() {
  }

  public CreateCampaignVariant201Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public CreateCampaignVariant201Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public CreateCampaignVariant201Response variant(@javax.annotation.Nullable CampaignVariant variant) {
   ...
   */
  @javax.annotation.Nullable
  public CampaignVariant getVariant() {
    return variant;
  }

  public void setVariant(@javax.annotation.Nullable CampaignVariant variant) {
    this.variant = variant;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateCampaignVariant201Response createCampaignVariant201Response = (CreateCampaignVariant201Response) o;
    return Objects.equals(this.schemaVersion, createCampaignVariant201Response.schemaVersion) &&
        Objects.equals(this.requestId, createCampaignVariant201Response.requestId) &&
        Objects.equals(this.variant, createCampaignVariant201Response.variant);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, variant);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "variant"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCampaignVariant201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCampaignVariant201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateCampaignVariant201Response is not found in the empty JSON string", CreateCampaignVariant201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCampaignVariant201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateCampaignVariant201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("variant") != null && !jsonObj.get("variant").isJsonNull()) {
        CampaignVariant.validateJsonElement(jsonObj.get("variant"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCampaignVariant201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCampaignVariant201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCampaignVariant201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCampaignVariant201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCampaignVariant201Response>() {
           @Override
           public void write(JsonWriter out, CreateCampaignVariant201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCampaignVariant201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCampaignVariant201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCampaignVariant201Response
   * @throws IOException if the JSON string is invalid with respect to CreateCampaignVariant201Response
   */
  public static CreateCampaignVariant201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCampaignVariant201Response.class);
  }

  /**
   * Convert an instance of CreateCampaignVariant201Response to an JSON string
   *
   * @return JSON string
   */
