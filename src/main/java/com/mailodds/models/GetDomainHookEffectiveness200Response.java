...
public class GetDomainHookEffectiveness200Response {
  ...
  public static final String SERIALIZED_NAME_EFFECTIVENESS = "effectiveness";
  @SerializedName(SERIALIZED_NAME_EFFECTIVENESS)
  @javax.annotation.Nullable
  private Object effectiveness;

  public GetDomainHookEffectiveness200Response() {
  }

  public GetDomainHookEffectiveness200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetDomainHookEffectiveness200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetDomainHookEffectiveness200Response effectiveness(@javax.annotation.Nullable Object effectiveness) {
   ...
   */
  @javax.annotation.Nullable
  public Object getEffectiveness() {
    return effectiveness;
  }

  public void setEffectiveness(@javax.annotation.Nullable Object effectiveness) {
    this.effectiveness = effectiveness;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetDomainHookEffectiveness200Response getDomainHookEffectiveness200Response = (GetDomainHookEffectiveness200Response) o;
    return Objects.equals(this.schemaVersion, getDomainHookEffectiveness200Response.schemaVersion) &&
        Objects.equals(this.requestId, getDomainHookEffectiveness200Response.requestId) &&
        Objects.equals(this.effectiveness, getDomainHookEffectiveness200Response.effectiveness);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, effectiveness);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "effectiveness"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetDomainHookEffectiveness200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDomainHookEffectiveness200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetDomainHookEffectiveness200Response is not found in the empty JSON string", GetDomainHookEffectiveness200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDomainHookEffectiveness200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDomainHookEffectiveness200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetDomainHookEffectiveness200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetDomainHookEffectiveness200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetDomainHookEffectiveness200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetDomainHookEffectiveness200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetDomainHookEffectiveness200Response>() {
           @Override
           public void write(JsonWriter out, GetDomainHookEffectiveness200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetDomainHookEffectiveness200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetDomainHookEffectiveness200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetDomainHookEffectiveness200Response
   * @throws IOException if the JSON string is invalid with respect to GetDomainHookEffectiveness200Response
   */
  public static GetDomainHookEffectiveness200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDomainHookEffectiveness200Response.class);
  }

  /**
   * Convert an instance of GetDomainHookEffectiveness200Response to an JSON string
   *
   * @return JSON string
   */
