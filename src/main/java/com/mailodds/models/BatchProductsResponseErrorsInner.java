...
public class BatchProductsResponseErrorsInner {
  ...
  public BatchProductsResponseErrorsInner() {
  }

  public BatchProductsResponseErrorsInner externalId(@javax.annotation.Nullable String externalId) {
  ...
  public BatchProductsResponseErrorsInner error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    BatchProductsResponseErrorsInner batchProductsResponseErrorsInner = (BatchProductsResponseErrorsInner) o;
    return Objects.equals(this.externalId, batchProductsResponseErrorsInner.externalId) &&
        Objects.equals(this.error, batchProductsResponseErrorsInner.error);
  }

  @Override
  public int hashCode() {
    return Objects.hash(externalId, error);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("external_id", "error"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchProductsResponseErrorsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchProductsResponseErrorsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BatchProductsResponseErrorsInner is not found in the empty JSON string", BatchProductsResponseErrorsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchProductsResponseErrorsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BatchProductsResponseErrorsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchProductsResponseErrorsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchProductsResponseErrorsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchProductsResponseErrorsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchProductsResponseErrorsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchProductsResponseErrorsInner>() {
           @Override
           public void write(JsonWriter out, BatchProductsResponseErrorsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchProductsResponseErrorsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchProductsResponseErrorsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchProductsResponseErrorsInner
   * @throws IOException if the JSON string is invalid with respect to BatchProductsResponseErrorsInner
   */
  public static BatchProductsResponseErrorsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchProductsResponseErrorsInner.class);
  }

  /**
   * Convert an instance of BatchProductsResponseErrorsInner to an JSON string
   *
   * @return JSON string
   */
