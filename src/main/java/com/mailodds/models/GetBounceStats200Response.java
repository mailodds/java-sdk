...
public class GetBounceStats200Response {
  ...
  public GetBounceStats200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetBounceStats200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public boolean equals(Object o) {
    ...
    GetBounceStats200Response getBounceStats200Response = (GetBounceStats200Response) o;
    return Objects.equals(this.schemaVersion, getBounceStats200Response.schemaVersion) &&
        Objects.equals(this.requestId, getBounceStats200Response.requestId) &&
        Objects.equals(this.stats, getBounceStats200Response.stats);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, stats);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "stats"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetBounceStats200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetBounceStats200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetBounceStats200Response is not found in the empty JSON string", GetBounceStats200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetBounceStats200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetBounceStats200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetBounceStats200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetBounceStats200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetBounceStats200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetBounceStats200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetBounceStats200Response>() {
           @Override
           public void write(JsonWriter out, GetBounceStats200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetBounceStats200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetBounceStats200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetBounceStats200Response
   * @throws IOException if the JSON string is invalid with respect to GetBounceStats200Response
   */
  public static GetBounceStats200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetBounceStats200Response.class);
  }

  /**
   * Convert an instance of GetBounceStats200Response to an JSON string
   *
   * @return JSON string
   */
