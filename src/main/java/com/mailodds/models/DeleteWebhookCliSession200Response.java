...
public class DeleteWebhookCliSession200Response {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteWebhookCliSession200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteWebhookCliSession200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteWebhookCliSession200Response is not found in the empty JSON string", DeleteWebhookCliSession200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteWebhookCliSession200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteWebhookCliSession200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteWebhookCliSession200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteWebhookCliSession200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteWebhookCliSession200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteWebhookCliSession200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteWebhookCliSession200Response>() {
           @Override
           public void write(JsonWriter out, DeleteWebhookCliSession200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteWebhookCliSession200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteWebhookCliSession200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteWebhookCliSession200Response
   * @throws IOException if the JSON string is invalid with respect to DeleteWebhookCliSession200Response
   */
  public static DeleteWebhookCliSession200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteWebhookCliSession200Response.class);
  }

  /**
   * Convert an instance of DeleteWebhookCliSession200Response to an JSON string
   *
   * @return JSON string
   */
