...
public class RunServerTestRequest {
  public static final String SERIALIZED_NAME_DOMAIN = "domain";
  @SerializedName(SERIALIZED_NAME_DOMAIN)
  @javax.annotation.Nonnull
  private String domain;

  public RunServerTestRequest() {
  }

  public RunServerTestRequest domain(@javax.annotation.Nonnull String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RunServerTestRequest runServerTestRequest = (RunServerTestRequest) o;
    return Objects.equals(this.domain, runServerTestRequest.domain);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RunServerTestRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunServerTestRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RunServerTestRequest is not found in the empty JSON string", RunServerTestRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunServerTestRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RunServerTestRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RunServerTestRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RunServerTestRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RunServerTestRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RunServerTestRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RunServerTestRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RunServerTestRequest>() {
           @Override
           public void write(JsonWriter out, RunServerTestRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RunServerTestRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RunServerTestRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RunServerTestRequest
   * @throws IOException if the JSON string is invalid with respect to RunServerTestRequest
   */
  public static RunServerTestRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RunServerTestRequest.class);
  }

  /**
   * Convert an instance of RunServerTestRequest to an JSON string
   *
   * @return JSON string
   */
