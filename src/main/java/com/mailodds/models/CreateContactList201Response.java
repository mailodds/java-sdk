...
public class CreateContactList201Response {
  ...
  public CreateContactList201Response() {
  }

  public CreateContactList201Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public CreateContactList201Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public CreateContactList201Response contactList(@javax.annotation.Nullable ContactList contactList) {
  ...
  public boolean equals(Object o) {
    ...
    CreateContactList201Response createContactList201Response = (CreateContactList201Response) o;
    return Objects.equals(this.schemaVersion, createContactList201Response.schemaVersion) &&
        Objects.equals(this.requestId, createContactList201Response.requestId) &&
        Objects.equals(this.contactList, createContactList201Response.contactList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, contactList);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "contact_list"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateContactList201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateContactList201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateContactList201Response is not found in the empty JSON string", CreateContactList201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateContactList201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateContactList201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateContactList201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateContactList201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateContactList201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateContactList201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateContactList201Response>() {
           @Override
           public void write(JsonWriter out, CreateContactList201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateContactList201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateContactList201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateContactList201Response
   * @throws IOException if the JSON string is invalid with respect to CreateContactList201Response
   */
  public static CreateContactList201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateContactList201Response.class);
  }

  /**
   * Convert an instance of CreateContactList201Response to an JSON string
   *
   * @return JSON string
   */
