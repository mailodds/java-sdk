...
import com.mailodds.models.StoreConnection;
...
public class CreateStore201Response {
  ...
  public CreateStore201Response() {
  }

  public CreateStore201Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public CreateStore201Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public CreateStore201Response store(@javax.annotation.Nullable StoreConnection store) {
    this.store = store;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public StoreConnection getStore() {
    return store;
  }

  public void setStore(@javax.annotation.Nullable StoreConnection store) {
    this.store = store;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateStore201Response createStore201Response = (CreateStore201Response) o;
    return Objects.equals(this.schemaVersion, createStore201Response.schemaVersion) &&
        Objects.equals(this.requestId, createStore201Response.requestId) &&
        Objects.equals(this.store, createStore201Response.store);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, store);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "store"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStore201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStore201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateStore201Response is not found in the empty JSON string", CreateStore201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStore201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateStore201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("store") != null && !jsonObj.get("store").isJsonNull()) {
        StoreConnection.validateJsonElement(jsonObj.get("store"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStore201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStore201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStore201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStore201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStore201Response>() {
           @Override
           public void write(JsonWriter out, CreateStore201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStore201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStore201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStore201Response
   * @throws IOException if the JSON string is invalid with respect to CreateStore201Response
   */
  public static CreateStore201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStore201Response.class);
  }

  /**
   * Convert an instance of CreateStore201Response to an JSON string
   *
   * @return JSON string
   */
