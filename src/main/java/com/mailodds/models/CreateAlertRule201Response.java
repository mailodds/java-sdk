...
public class CreateAlertRule201Response {
  ...
  public CreateAlertRule201Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public CreateAlertRule201Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public CreateAlertRule201Response rule(@javax.annotation.Nullable AlertRule rule) {
    this.rule = rule;
    return this;
  }
  ...
  public void setRule(@javax.annotation.Nullable AlertRule rule) {
    this.rule = rule;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.schemaVersion, createAlertRule201Response.schemaVersion) &&
        Objects.equals(this.requestId, createAlertRule201Response.requestId) &&
        Objects.equals(this.rule, createAlertRule201Response.rule);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, rule);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "rule"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAlertRule201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateAlertRule201Response is not found in the empty JSON string", CreateAlertRule201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAlertRule201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateAlertRule201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("rule") != null && !jsonObj.get("rule").isJsonNull()) {
        AlertRule.validateJsonElement(jsonObj.get("rule"));
      }
  }
