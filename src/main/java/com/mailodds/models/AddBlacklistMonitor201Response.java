...
public class AddBlacklistMonitor201Response {
  ...
  public AddBlacklistMonitor201Response() {
  }

  public AddBlacklistMonitor201Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public AddBlacklistMonitor201Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public AddBlacklistMonitor201Response monitor(@javax.annotation.Nullable BlacklistMonitor monitor) {
  ...
  public boolean equals(Object o) {
    ...
    AddBlacklistMonitor201Response addBlacklistMonitor201Response = (AddBlacklistMonitor201Response) o;
    return Objects.equals(this.schemaVersion, addBlacklistMonitor201Response.schemaVersion) &&
        Objects.equals(this.requestId, addBlacklistMonitor201Response.requestId) &&
        Objects.equals(this.monitor, addBlacklistMonitor201Response.monitor);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, monitor);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "monitor"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddBlacklistMonitor201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddBlacklistMonitor201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AddBlacklistMonitor201Response is not found in the empty JSON string", AddBlacklistMonitor201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddBlacklistMonitor201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddBlacklistMonitor201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddBlacklistMonitor201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddBlacklistMonitor201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddBlacklistMonitor201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddBlacklistMonitor201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AddBlacklistMonitor201Response>() {
           @Override
           public void write(JsonWriter out, AddBlacklistMonitor201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddBlacklistMonitor201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddBlacklistMonitor201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddBlacklistMonitor201Response
   * @throws IOException if the JSON string is invalid with respect to AddBlacklistMonitor201Response
   */
  public static AddBlacklistMonitor201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddBlacklistMonitor201Response.class);
  }

  /**
   * Convert an instance of AddBlacklistMonitor201Response to an JSON string
   *
   * @return JSON string
   */
