...
public class CreateVariantRequest {
  ...
  public CreateVariantRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateVariantRequest subject(@javax.annotation.Nonnull String subject) {
  ...
  public CreateVariantRequest html(@javax.annotation.Nullable String html) {
    this.html = html;
    return this;
  }
  ...
  public CreateVariantRequest text(@javax.annotation.Nullable String text) {
    this.text = text;
    return this;
  }
  ...
  public CreateVariantRequest weight(@javax.annotation.Nonnull Integer weight) {
    this.weight = weight;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateVariantRequest createVariantRequest = (CreateVariantRequest) o;
    return Objects.equals(this.name, createVariantRequest.name) &&
        Objects.equals(this.subject, createVariantRequest.subject) &&
        Objects.equals(this.html, createVariantRequest.html) &&
        Objects.equals(this.text, createVariantRequest.text) &&
        Objects.equals(this.weight, createVariantRequest.weight);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, subject, html, text, weight);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "subject", "html", "text", "weight"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "subject", "weight"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateVariantRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateVariantRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateVariantRequest is not found in the empty JSON string", CreateVariantRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateVariantRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateVariantRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateVariantRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateVariantRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateVariantRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateVariantRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateVariantRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateVariantRequest>() {
           @Override
           public void write(JsonWriter out, CreateVariantRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateVariantRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateVariantRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateVariantRequest
   * @throws IOException if the JSON string is invalid with respect to CreateVariantRequest
   */
  public static CreateVariantRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateVariantRequest.class);
  }

  /**
   * Convert an instance of CreateVariantRequest to an JSON string
   *
   * @return JSON string
   */
