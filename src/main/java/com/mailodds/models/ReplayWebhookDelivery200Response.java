...
public class ReplayWebhookDelivery200Response {
  ...
  public ReplayWebhookDelivery200Response() {
  }

  public ReplayWebhookDelivery200Response status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public ReplayWebhookDelivery200Response deliveryId(@javax.annotation.Nullable Integer deliveryId) {
  ...
  public void setDeliveryId(@javax.annotation.Nullable Integer deliveryId) {
    this.deliveryId = deliveryId;
  }
  ...
  public boolean equals(Object o) {
    ...
    ReplayWebhookDelivery200Response replayWebhookDelivery200Response = (ReplayWebhookDelivery200Response) o;
    return Objects.equals(this.status, replayWebhookDelivery200Response.status) &&
        Objects.equals(this.deliveryId, replayWebhookDelivery200Response.deliveryId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, deliveryId);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "delivery_id"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReplayWebhookDelivery200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReplayWebhookDelivery200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReplayWebhookDelivery200Response is not found in the empty JSON string", ReplayWebhookDelivery200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReplayWebhookDelivery200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ReplayWebhookDelivery200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplayWebhookDelivery200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplayWebhookDelivery200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplayWebhookDelivery200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplayWebhookDelivery200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplayWebhookDelivery200Response>() {
           @Override
           public void write(JsonWriter out, ReplayWebhookDelivery200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReplayWebhookDelivery200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReplayWebhookDelivery200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReplayWebhookDelivery200Response
   * @throws IOException if the JSON string is invalid with respect to ReplayWebhookDelivery200Response
   */
  public static ReplayWebhookDelivery200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReplayWebhookDelivery200Response.class);
  }

  /**
   * Convert an instance of ReplayWebhookDelivery200Response to an JSON string
   *
   * @return JSON string
   */
