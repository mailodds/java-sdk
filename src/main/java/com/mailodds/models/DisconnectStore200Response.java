...
public class DisconnectStore200Response {
  ...
  public DisconnectStore200Response() {
  }

  public DisconnectStore200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public DisconnectStore200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public DisconnectStore200Response disconnected(@javax.annotation.Nullable Boolean disconnected) {
  ...
  public boolean equals(Object o) {
    ...
    DisconnectStore200Response disconnectStore200Response = (DisconnectStore200Response) o;
    return Objects.equals(this.schemaVersion, disconnectStore200Response.schemaVersion) &&
        Objects.equals(this.requestId, disconnectStore200Response.requestId) &&
        Objects.equals(this.disconnected, disconnectStore200Response.disconnected);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, disconnected);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "disconnected"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DisconnectStore200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisconnectStore200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DisconnectStore200Response is not found in the empty JSON string", DisconnectStore200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisconnectStore200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DisconnectStore200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisconnectStore200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisconnectStore200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisconnectStore200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisconnectStore200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DisconnectStore200Response>() {
           @Override
           public void write(JsonWriter out, DisconnectStore200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisconnectStore200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DisconnectStore200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DisconnectStore200Response
   * @throws IOException if the JSON string is invalid with respect to DisconnectStore200Response
   */
  public static DisconnectStore200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisconnectStore200Response.class);
  }

  /**
   * Convert an instance of DisconnectStore200Response to an JSON string
   *
   * @return JSON string
   */
