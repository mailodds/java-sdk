...
public class GetEngagementScore200Response {
  ...
  public static final String SERIALIZED_NAME_LAST_ENGAGED_AT = "last_engaged_at";
  @SerializedName(SERIALIZED_NAME_LAST_ENGAGED_AT)
  @javax.annotation.Nullable
  private OffsetDateTime lastEngagedAt;

  public GetEngagementScore200Response() {
  }

  public GetEngagementScore200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public GetEngagementScore200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public GetEngagementScore200Response email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public GetEngagementScore200Response score(@javax.annotation.Nullable BigDecimal score) {
    this.score = score;
    return this;
  }
  ...
  public GetEngagementScore200Response lastEngagedAt(@javax.annotation.Nullable OffsetDateTime lastEngagedAt) {
   ...
   */
  @javax.annotation.Nullable
  public OffsetDateTime getLastEngagedAt() {
    return lastEngagedAt;
  }

  public void setLastEngagedAt(@javax.annotation.Nullable OffsetDateTime lastEngagedAt) {
    this.lastEngagedAt = lastEngagedAt;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetEngagementScore200Response getEngagementScore200Response = (GetEngagementScore200Response) o;
    return Objects.equals(this.schemaVersion, getEngagementScore200Response.schemaVersion) &&
        Objects.equals(this.requestId, getEngagementScore200Response.requestId) &&
        Objects.equals(this.email, getEngagementScore200Response.email) &&
        Objects.equals(this.score, getEngagementScore200Response.score) &&
        Objects.equals(this.lastEngagedAt, getEngagementScore200Response.lastEngagedAt);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, email, score, lastEngagedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("    lastEngagedAt: ").append(toIndentedString(lastEngagedAt)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "email", "score", "last_engaged_at"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetEngagementScore200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetEngagementScore200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetEngagementScore200Response is not found in the empty JSON string", GetEngagementScore200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetEngagementScore200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetEngagementScore200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetEngagementScore200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetEngagementScore200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetEngagementScore200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetEngagementScore200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetEngagementScore200Response>() {
           @Override
           public void write(JsonWriter out, GetEngagementScore200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetEngagementScore200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetEngagementScore200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetEngagementScore200Response
   * @throws IOException if the JSON string is invalid with respect to GetEngagementScore200Response
   */
  public static GetEngagementScore200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetEngagementScore200Response.class);
  }

  /**
   * Convert an instance of GetEngagementScore200Response to an JSON string
   *
   * @return JSON string
   */
