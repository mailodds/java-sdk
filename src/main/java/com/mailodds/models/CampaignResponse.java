...
public class CampaignResponse {
  ...
  @javax.annotation.Nullable
  private List<CampaignVariant> variants = new ArrayList<>();

  public CampaignResponse() {
  }

  public CampaignResponse schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public CampaignResponse requestId(@javax.annotation.Nullable String requestId) {
  ...
  public CampaignResponse campaign(@javax.annotation.Nullable Campaign campaign) {
  ...
  public CampaignResponse variants(@javax.annotation.Nullable List<CampaignVariant> variants) {
    this.variants = variants;
    return this;
  }

  public CampaignResponse addVariantsItem(CampaignVariant variantsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<CampaignVariant> getVariants() {
    return variants;
  }

  public void setVariants(@javax.annotation.Nullable List<CampaignVariant> variants) {
    this.variants = variants;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.schemaVersion, campaignResponse.schemaVersion) &&
        Objects.equals(this.requestId, campaignResponse.requestId) &&
        Objects.equals(this.campaign, campaignResponse.campaign) &&
        Objects.equals(this.variants, campaignResponse.variants);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, campaign, variants);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "campaign", "variants"));
      ...
      if (jsonObj.get("variants") != null && !jsonObj.get("variants").isJsonNull()) {
        ...
        if (jsonArrayvariants != null) {
          ...
          for (int i = 0; i < jsonArrayvariants.size(); i++) {
            CampaignVariant.validateJsonElement(jsonArrayvariants.get(i));
          };
        }
      }
  }
