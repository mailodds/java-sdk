...
public class BatchCheckOooRequest {
  public static final String SERIALIZED_NAME_EMAILS = "emails";
  @SerializedName(SERIALIZED_NAME_EMAILS)
  @javax.annotation.Nonnull
  private List<String> emails = new ArrayList<>();

  public BatchCheckOooRequest() {
  }

  public BatchCheckOooRequest emails(@javax.annotation.Nonnull List<String> emails) {
    this.emails = emails;
    return this;
  }

  public BatchCheckOooRequest addEmailsItem(String emailsItem) {
    if (this.emails == null) {
  ...
  public boolean equals(Object o) {
    ...
    BatchCheckOooRequest batchCheckOooRequest = (BatchCheckOooRequest) o;
    return Objects.equals(this.emails, batchCheckOooRequest.emails);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchCheckOooRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchCheckOooRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BatchCheckOooRequest is not found in the empty JSON string", BatchCheckOooRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchCheckOooRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BatchCheckOooRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchCheckOooRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchCheckOooRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchCheckOooRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchCheckOooRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchCheckOooRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchCheckOooRequest>() {
           @Override
           public void write(JsonWriter out, BatchCheckOooRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchCheckOooRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchCheckOooRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchCheckOooRequest
   * @throws IOException if the JSON string is invalid with respect to BatchCheckOooRequest
   */
  public static BatchCheckOooRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchCheckOooRequest.class);
  }

  /**
   * Convert an instance of BatchCheckOooRequest to an JSON string
   *
   * @return JSON string
   */
