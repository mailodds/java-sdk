...
public class ListOooContacts200Response {
  ...
  public ListOooContacts200Response() {
  }

  public ListOooContacts200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public ListOooContacts200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public ListOooContacts200Response contacts(@javax.annotation.Nullable List<Object> contacts) {
    this.contacts = contacts;
    return this;
  }

  public ListOooContacts200Response addContactsItem(Object contactsItem) {
  ...
  public void setContacts(@javax.annotation.Nullable List<Object> contacts) {
    this.contacts = contacts;
  }


  public ListOooContacts200Response total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ListOooContacts200Response page(@javax.annotation.Nullable Integer page) {
    this.page = page;
    return this;
  }
  ...
  public ListOooContacts200Response perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public boolean equals(Object o) {
    ...
    ListOooContacts200Response listOooContacts200Response = (ListOooContacts200Response) o;
    return Objects.equals(this.schemaVersion, listOooContacts200Response.schemaVersion) &&
        Objects.equals(this.requestId, listOooContacts200Response.requestId) &&
        Objects.equals(this.contacts, listOooContacts200Response.contacts) &&
        Objects.equals(this.total, listOooContacts200Response.total) &&
        Objects.equals(this.page, listOooContacts200Response.page) &&
        Objects.equals(this.perPage, listOooContacts200Response.perPage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, contacts, total, page, perPage);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "contacts", "total", "page", "per_page"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListOooContacts200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListOooContacts200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListOooContacts200Response is not found in the empty JSON string", ListOooContacts200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListOooContacts200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListOooContacts200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListOooContacts200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListOooContacts200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListOooContacts200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListOooContacts200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ListOooContacts200Response>() {
           @Override
           public void write(JsonWriter out, ListOooContacts200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListOooContacts200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListOooContacts200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListOooContacts200Response
   * @throws IOException if the JSON string is invalid with respect to ListOooContacts200Response
   */
  public static ListOooContacts200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListOooContacts200Response.class);
  }

  /**
   * Convert an instance of ListOooContacts200Response to an JSON string
   *
   * @return JSON string
   */
