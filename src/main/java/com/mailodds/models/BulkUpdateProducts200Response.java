...
public class BulkUpdateProducts200Response {
  ...
  public BulkUpdateProducts200Response() {
  }

  public BulkUpdateProducts200Response schemaVersion(@javax.annotation.Nullable String schemaVersion) {
  ...
  public BulkUpdateProducts200Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public BulkUpdateProducts200Response updated(@javax.annotation.Nullable Integer updated) {
  ...
  public boolean equals(Object o) {
    ...
    BulkUpdateProducts200Response bulkUpdateProducts200Response = (BulkUpdateProducts200Response) o;
    return Objects.equals(this.schemaVersion, bulkUpdateProducts200Response.schemaVersion) &&
        Objects.equals(this.requestId, bulkUpdateProducts200Response.requestId) &&
        Objects.equals(this.updated, bulkUpdateProducts200Response.updated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, updated);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "updated"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to BulkUpdateProducts200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BulkUpdateProducts200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BulkUpdateProducts200Response is not found in the empty JSON string", BulkUpdateProducts200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BulkUpdateProducts200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BulkUpdateProducts200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BulkUpdateProducts200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BulkUpdateProducts200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BulkUpdateProducts200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BulkUpdateProducts200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<BulkUpdateProducts200Response>() {
           @Override
           public void write(JsonWriter out, BulkUpdateProducts200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BulkUpdateProducts200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BulkUpdateProducts200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BulkUpdateProducts200Response
   * @throws IOException if the JSON string is invalid with respect to BulkUpdateProducts200Response
   */
  public static BulkUpdateProducts200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BulkUpdateProducts200Response.class);
  }

  /**
   * Convert an instance of BulkUpdateProducts200Response to an JSON string
   *
   * @return JSON string
   */
