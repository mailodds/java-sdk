...
import com.mailodds.models.BatchProductsRequestProductsInner;
...
public class BatchProductsRequest {
  ...
  private List<BatchProductsRequestProductsInner> products = new ArrayList<>();

  public BatchProductsRequest() {
  }

  public BatchProductsRequest products(@javax.annotation.Nonnull List<BatchProductsRequestProductsInner> products) {
    this.products = products;
    return this;
  }

  public BatchProductsRequest addProductsItem(BatchProductsRequestProductsInner productsItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<BatchProductsRequestProductsInner> getProducts() {
    return products;
  }

  public void setProducts(@javax.annotation.Nonnull List<BatchProductsRequestProductsInner> products) {
    this.products = products;
  }
  ...
  public boolean equals(Object o) {
    ...
    BatchProductsRequest batchProductsRequest = (BatchProductsRequest) o;
    return Objects.equals(this.products, batchProductsRequest.products);
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("products"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchProductsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchProductsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BatchProductsRequest is not found in the empty JSON string", BatchProductsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchProductsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BatchProductsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BatchProductsRequest.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayproducts.size(); i++) {
        BatchProductsRequestProductsInner.validateJsonElement(jsonArrayproducts.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchProductsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchProductsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchProductsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchProductsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchProductsRequest>() {
           @Override
           public void write(JsonWriter out, BatchProductsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchProductsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchProductsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchProductsRequest
   * @throws IOException if the JSON string is invalid with respect to BatchProductsRequest
   */
  public static BatchProductsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchProductsRequest.class);
  }

  /**
   * Convert an instance of BatchProductsRequest to an JSON string
   *
   * @return JSON string
   */
