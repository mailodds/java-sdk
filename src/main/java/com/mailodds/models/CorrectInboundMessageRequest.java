...
public class CorrectInboundMessageRequest {
  public static final String SERIALIZED_NAME_CORRECTION = "correction";
  @SerializedName(SERIALIZED_NAME_CORRECTION)
  @javax.annotation.Nonnull
  private String correction;

  public CorrectInboundMessageRequest() {
  }

  public CorrectInboundMessageRequest correction(@javax.annotation.Nonnull String correction) {
  ...
  public boolean equals(Object o) {
    ...
    CorrectInboundMessageRequest correctInboundMessageRequest = (CorrectInboundMessageRequest) o;
    return Objects.equals(this.correction, correctInboundMessageRequest.correction);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("correction"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("correction"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CorrectInboundMessageRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CorrectInboundMessageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CorrectInboundMessageRequest is not found in the empty JSON string", CorrectInboundMessageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CorrectInboundMessageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CorrectInboundMessageRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CorrectInboundMessageRequest.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (!jsonObj.get("correction").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `correction` to be a primitive type in the JSON string but got `%s`", jsonObj.get("correction").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CorrectInboundMessageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CorrectInboundMessageRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CorrectInboundMessageRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CorrectInboundMessageRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CorrectInboundMessageRequest>() {
           @Override
           public void write(JsonWriter out, CorrectInboundMessageRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CorrectInboundMessageRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CorrectInboundMessageRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CorrectInboundMessageRequest
   * @throws IOException if the JSON string is invalid with respect to CorrectInboundMessageRequest
   */
  public static CorrectInboundMessageRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CorrectInboundMessageRequest.class);
  }

  /**
   * Convert an instance of CorrectInboundMessageRequest to an JSON string
   *
   * @return JSON string
   */
