...
public class ReputationApi {
    ...
    /**
     * Build call for getReputation
     * @param period Evaluation period (optional, default to 7d)
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> Account reputation </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized - Invalid or missing API key </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getReputationCall(@javax.annotation.Nullable String period, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/reputation";
    ...
    private okhttp3.Call getReputationValidateBeforeCall(@javax.annotation.Nullable String period, final ApiCallback _callback) throws ApiException {
        return getReputationCall(period, _callback);
     ...
     */
    public GetReputation200Response getReputation(@javax.annotation.Nullable String period) throws ApiException {
        ApiResponse<GetReputation200Response> localVarResp = getReputationWithHttpInfo(period);
     ...
     * Get the aggregate reputation score and breakdown for the account.
     * @param period Evaluation period (optional, default to 7d)
     * @return ApiResponse&lt;GetReputation200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<GetReputation200Response> getReputationWithHttpInfo(@javax.annotation.Nullable String period) throws ApiException {
        okhttp3.Call localVarCall = getReputationValidateBeforeCall(period, null);
        Type localVarReturnType = new TypeToken<GetReputation200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get account reputation (asynchronously)
     * Get the aggregate reputation score and breakdown for the account.
     * @param period Evaluation period (optional, default to 7d)
     ...
     */
    public okhttp3.Call getReputationAsync(@javax.annotation.Nullable String period, final ApiCallback<GetReputation200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getReputationValidateBeforeCall(period, _callback);
        Type localVarReturnType = new TypeToken<GetReputation200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getReputationTimeline
     * @param period Timeline period (optional, default to 30d)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Reputation timeline </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized - Invalid or missing API key </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getReputationTimelineCall(@javax.annotation.Nullable String period, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v1/reputation/timeline";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getReputationTimelineValidateBeforeCall(@javax.annotation.Nullable String period, final ApiCallback _callback) throws ApiException {
        return getReputationTimelineCall(period, _callback);
     ...
     */
    public GetReputationTimeline200Response getReputationTimeline(@javax.annotation.Nullable String period) throws ApiException {
        ApiResponse<GetReputationTimeline200Response> localVarResp = getReputationTimelineWithHttpInfo(period);
        return localVarResp.getData();
    }
     ...
     * Get reputation metrics over time.
     * @param period Timeline period (optional, default to 30d)
     * @return ApiResponse&lt;GetReputationTimeline200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<GetReputationTimeline200Response> getReputationTimelineWithHttpInfo(@javax.annotation.Nullable String period) throws ApiException {
        okhttp3.Call localVarCall = getReputationTimelineValidateBeforeCall(period, null);
        Type localVarReturnType = new TypeToken<GetReputationTimeline200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get reputation timeline (asynchronously)
     * Get reputation metrics over time.
     * @param period Timeline period (optional, default to 30d)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getReputationTimelineAsync(@javax.annotation.Nullable String period, final ApiCallback<GetReputationTimeline200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getReputationTimelineValidateBeforeCall(period, _callback);
        Type localVarReturnType = new TypeToken<GetReputationTimeline200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
