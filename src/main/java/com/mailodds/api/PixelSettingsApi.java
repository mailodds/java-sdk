...
public class PixelSettingsApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PixelSettingsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public PixelSettingsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getPixelSettings
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> Pixel settings </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized - Invalid or missing API key </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getPixelSettingsCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/pixel-settings";
    ...
    private okhttp3.Call getPixelSettingsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getPixelSettingsCall(_callback);
     ...
     */
    public GetPixelSettings200Response getPixelSettings() throws ApiException {
        ApiResponse<GetPixelSettings200Response> localVarResp = getPixelSettingsWithHttpInfo();
     ...
     * Get pixel settings
     * Get the web pixel tracking configuration.
     * @return ApiResponse&lt;GetPixelSettings200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<GetPixelSettings200Response> getPixelSettingsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getPixelSettingsValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<GetPixelSettings200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get pixel settings (asynchronously)
     * Get the web pixel tracking configuration.
     ...
     */
    public okhttp3.Call getPixelSettingsAsync(final ApiCallback<GetPixelSettings200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPixelSettingsValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<GetPixelSettings200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for updatePixelSettings
     * @param updatePixelSettingsRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call updatePixelSettingsCall(@javax.annotation.Nonnull UpdatePixelSettingsRequest updatePixelSettingsRequest, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = updatePixelSettingsRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updatePixelSettingsValidateBeforeCall(@javax.annotation.Nonnull UpdatePixelSettingsRequest updatePixelSettingsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'updatePixelSettingsRequest' is set
        if (updatePixelSettingsRequest == null) {
            throw new ApiException("Missing the required parameter 'updatePixelSettingsRequest' when calling updatePixelSettings(Async)");
        }

        return updatePixelSettingsCall(updatePixelSettingsRequest, _callback);
    ...
    public GetPixelSettings200Response updatePixelSettings(@javax.annotation.Nonnull UpdatePixelSettingsRequest updatePixelSettingsRequest) throws ApiException {
        ApiResponse<GetPixelSettings200Response> localVarResp = updatePixelSettingsWithHttpInfo(updatePixelSettingsRequest);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<GetPixelSettings200Response> updatePixelSettingsWithHttpInfo(@javax.annotation.Nonnull UpdatePixelSettingsRequest updatePixelSettingsRequest) throws ApiException {
        okhttp3.Call localVarCall = updatePixelSettingsValidateBeforeCall(updatePixelSettingsRequest, null);
        Type localVarReturnType = new TypeToken<GetPixelSettings200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update pixel settings (asynchronously)
     * Update the web pixel subscribe list configuration.
     * @param updatePixelSettingsRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    public okhttp3.Call updatePixelSettingsAsync(@javax.annotation.Nonnull UpdatePixelSettingsRequest updatePixelSettingsRequest, final ApiCallback<GetPixelSettings200Response> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updatePixelSettingsValidateBeforeCall(updatePixelSettingsRequest, _callback);
        Type localVarReturnType = new TypeToken<GetPixelSettings200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
