...
public class EventsApi {
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> Idempotent duplicate (event already exists) </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized - Invalid or missing API key </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call trackEventCall(@javax.annotation.Nonnull TrackEventRequest trackEventRequest, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/events/track";
    ...
    private okhttp3.Call trackEventValidateBeforeCall(@javax.annotation.Nonnull TrackEventRequest trackEventRequest, final ApiCallback _callback) throws ApiException {
     ...
     */
    public TrackEventResponse trackEvent(@javax.annotation.Nonnull TrackEventRequest trackEventRequest) throws ApiException {
        ApiResponse<TrackEventResponse> localVarResp = trackEventWithHttpInfo(trackEventRequest);
     ...
     */
    public ApiResponse<TrackEventResponse> trackEventWithHttpInfo(@javax.annotation.Nonnull TrackEventRequest trackEventRequest) throws ApiException {
    ...
    /**
     * Track a commerce event (asynchronously)
     * Ingest a commerce event (purchase, cart abandonment, browse, wishlist, review, etc.). Supports idempotency via the idempotency_key field (5 minute Redis TTL + DB unique constraint).
     * @param trackEventRequest  (required)
     ...
     */
    public okhttp3.Call trackEventAsync(@javax.annotation.Nonnull TrackEventRequest trackEventRequest, final ApiCallback<TrackEventResponse> _callback) throws ApiException {
