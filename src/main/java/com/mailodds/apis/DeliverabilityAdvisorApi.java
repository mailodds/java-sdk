...
public class DeliverabilityAdvisorApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public DeliverabilityAdvisorApi() {
        this(Configuration.getDefaultApiClient());
    }

    public DeliverabilityAdvisorApi(ApiClient apiClient) {
    ...
    /**
     * Build call for dismissDeliverabilityRecommendation
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> Dismiss a deliverability recommendation </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized - Invalid or missing API key </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call dismissDeliverabilityRecommendationCall(@javax.annotation.Nonnull String recommendationId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/deliverability/recommendations/{recommendation_id}/dismiss"
            .replace("{" + "recommendation_id" + "}", localVarApiClient.escapeString(recommendationId.toString()));
    ...
    private okhttp3.Call dismissDeliverabilityRecommendationValidateBeforeCall(@javax.annotation.Nonnull String recommendationId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'recommendationId' is set
        if (recommendationId == null) {
            throw new ApiException("Missing the required parameter 'recommendationId' when calling dismissDeliverabilityRecommendation(Async)");
        }

        return dismissDeliverabilityRecommendationCall(recommendationId, _callback);
     ...
     */
    public void dismissDeliverabilityRecommendation(@javax.annotation.Nonnull String recommendationId) throws ApiException {
        dismissDeliverabilityRecommendationWithHttpInfo(recommendationId);
    }
     ...
     */
    public ApiResponse<Void> dismissDeliverabilityRecommendationWithHttpInfo(@javax.annotation.Nonnull String recommendationId) throws ApiException {
        okhttp3.Call localVarCall = dismissDeliverabilityRecommendationValidateBeforeCall(recommendationId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Dismiss a deliverability recommendation (asynchronously)
     * Dismiss a deliverability recommendation so it no longer appears.
     * @param recommendationId  (required)
     ...
     */
    public okhttp3.Call dismissDeliverabilityRecommendationAsync(@javax.annotation.Nonnull String recommendationId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = dismissDeliverabilityRecommendationValidateBeforeCall(recommendationId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for getDeliverabilityRecommendations
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Get deliverability recommendations </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized - Invalid or missing API key </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getDeliverabilityRecommendationsCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v1/deliverability/recommendations";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDeliverabilityRecommendationsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getDeliverabilityRecommendationsCall(_callback);
     ...
     */
    public void getDeliverabilityRecommendations() throws ApiException {
        getDeliverabilityRecommendationsWithHttpInfo();
    }
     ...
     */
    public ApiResponse<Void> getDeliverabilityRecommendationsWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getDeliverabilityRecommendationsValidateBeforeCall(null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get deliverability recommendations (asynchronously)
     * Retrieve actionable deliverability recommendations for the account.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getDeliverabilityRecommendationsAsync(final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDeliverabilityRecommendationsValidateBeforeCall(_callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
