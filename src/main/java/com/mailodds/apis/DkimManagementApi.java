...
public class DkimManagementApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public DkimManagementApi() {
        this(Configuration.getDefaultApiClient());
    }

    public DkimManagementApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getDkimDnsRecord
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> Get DKIM DNS record </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized - Invalid or missing API key </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getDkimDnsRecordCall(@javax.annotation.Nonnull String domainId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/sending-domains/{domain_id}/dkim/dns-record"
    ...
    private okhttp3.Call getDkimDnsRecordValidateBeforeCall(@javax.annotation.Nonnull String domainId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'domainId' is set
        if (domainId == null) {
            throw new ApiException("Missing the required parameter 'domainId' when calling getDkimDnsRecord(Async)");
        }

        return getDkimDnsRecordCall(domainId, _callback);
     ...
     */
    public void getDkimDnsRecord(@javax.annotation.Nonnull String domainId) throws ApiException {
        getDkimDnsRecordWithHttpInfo(domainId);
    }
     ...
     */
    public ApiResponse<Void> getDkimDnsRecordWithHttpInfo(@javax.annotation.Nonnull String domainId) throws ApiException {
        okhttp3.Call localVarCall = getDkimDnsRecordValidateBeforeCall(domainId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get DKIM DNS record (asynchronously)
     * Retrieve the current DKIM DNS record and selector for a sending domain.
     * @param domainId  (required)
     ...
     */
    public okhttp3.Call getDkimDnsRecordAsync(@javax.annotation.Nonnull String domainId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDkimDnsRecordValidateBeforeCall(domainId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for rotateDkim
     * @param domainId  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Rotate DKIM keys </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized - Invalid or missing API key </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call rotateDkimCall(@javax.annotation.Nonnull String domainId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v1/sending-domains/{domain_id}/dkim/rotate"
            .replace("{" + "domain_id" + "}", localVarApiClient.escapeString(domainId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call rotateDkimValidateBeforeCall(@javax.annotation.Nonnull String domainId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'domainId' is set
        if (domainId == null) {
            throw new ApiException("Missing the required parameter 'domainId' when calling rotateDkim(Async)");
        }

        return rotateDkimCall(domainId, _callback);
     ...
     */
    public void rotateDkim(@javax.annotation.Nonnull String domainId) throws ApiException {
        rotateDkimWithHttpInfo(domainId);
    }
     ...
     */
    public ApiResponse<Void> rotateDkimWithHttpInfo(@javax.annotation.Nonnull String domainId) throws ApiException {
        okhttp3.Call localVarCall = rotateDkimValidateBeforeCall(domainId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Rotate DKIM keys (asynchronously)
     * Generate a new DKIM key pair and rotate the selector for a sending domain.
     * @param domainId  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call rotateDkimAsync(@javax.annotation.Nonnull String domainId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = rotateDkimValidateBeforeCall(domainId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
