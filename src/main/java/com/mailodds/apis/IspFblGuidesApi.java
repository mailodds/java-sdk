...
public class IspFblGuidesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public IspFblGuidesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public IspFblGuidesApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getIspFblGuide
     * @param ispId  (required)
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> Get ISP FBL guide </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized - Invalid or missing API key </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getIspFblGuideCall(@javax.annotation.Nonnull String ispId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/isp-fbl/guides/{isp_id}"
            .replace("{" + "isp_id" + "}", localVarApiClient.escapeString(ispId.toString()));
    ...
    private okhttp3.Call getIspFblGuideValidateBeforeCall(@javax.annotation.Nonnull String ispId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ispId' is set
        if (ispId == null) {
            throw new ApiException("Missing the required parameter 'ispId' when calling getIspFblGuide(Async)");
        }

        return getIspFblGuideCall(ispId, _callback);
     ...
     */
    public void getIspFblGuide(@javax.annotation.Nonnull String ispId) throws ApiException {
        getIspFblGuideWithHttpInfo(ispId);
    }
     ...
     */
    public ApiResponse<Void> getIspFblGuideWithHttpInfo(@javax.annotation.Nonnull String ispId) throws ApiException {
        okhttp3.Call localVarCall = getIspFblGuideValidateBeforeCall(ispId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Get ISP FBL guide (asynchronously)
     * Retrieve a specific ISP feedback loop setup guide.
     * @param ispId  (required)
     ...
     */
    public okhttp3.Call getIspFblGuideAsync(@javax.annotation.Nonnull String ispId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIspFblGuideValidateBeforeCall(ispId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for listIspFblGuides
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> List ISP FBL guides </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized - Invalid or missing API key </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listIspFblGuidesCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v1/isp-fbl/guides";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listIspFblGuidesValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return listIspFblGuidesCall(_callback);
     ...
     */
    public void listIspFblGuides() throws ApiException {
        listIspFblGuidesWithHttpInfo();
    }
     ...
     */
    public ApiResponse<Void> listIspFblGuidesWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = listIspFblGuidesValidateBeforeCall(null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * List ISP FBL guides (asynchronously)
     * List all ISP feedback loop setup guides.
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call listIspFblGuidesAsync(final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = listIspFblGuidesValidateBeforeCall(_callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
