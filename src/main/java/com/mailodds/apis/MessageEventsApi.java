...
import com.mailodds.models.GetMessageEvents200Response;
...
public class MessageEventsApi {
    ...
    public MessageEventsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public MessageEventsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getMessageEvents
     * @param messageId UUID of the sent message (required)
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> Message events with summary </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call getMessageEventsCall(@javax.annotation.Nonnull String messageId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/message-events";
    ...
    private okhttp3.Call getMessageEventsValidateBeforeCall(@javax.annotation.Nonnull String messageId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'messageId' is set
        if (messageId == null) {
            throw new ApiException("Missing the required parameter 'messageId' when calling getMessageEvents(Async)");
        }

        return getMessageEventsCall(messageId, _callback);
     ...
     */
    public GetMessageEvents200Response getMessageEvents(@javax.annotation.Nonnull String messageId) throws ApiException {
        ApiResponse<GetMessageEvents200Response> localVarResp = getMessageEventsWithHttpInfo(messageId);
     ...
     * Get delivery and engagement events for a specific sent message. Returns events in chronological order with bot detection.
     * @param messageId UUID of the sent message (required)
     * @return ApiResponse&lt;GetMessageEvents200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<GetMessageEvents200Response> getMessageEventsWithHttpInfo(@javax.annotation.Nonnull String messageId) throws ApiException {
        okhttp3.Call localVarCall = getMessageEventsValidateBeforeCall(messageId, null);
        Type localVarReturnType = new TypeToken<GetMessageEvents200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get message events (asynchronously)
     * Get delivery and engagement events for a specific sent message. Returns events in chronological order with bot detection.
     * @param messageId UUID of the sent message (required)
     ...
     */
    public okhttp3.Call getMessageEventsAsync(@javax.annotation.Nonnull String messageId, final ApiCallback<GetMessageEvents200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMessageEventsValidateBeforeCall(messageId, _callback);
        Type localVarReturnType = new TypeToken<GetMessageEvents200Response>(){}.getType();
