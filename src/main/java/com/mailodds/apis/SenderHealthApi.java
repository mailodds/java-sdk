...
import com.mailodds.models.GetSenderHealth200Response;
import com.mailodds.models.GetSenderHealthTrend200Response;
...
public class SenderHealthApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public SenderHealthApi() {
        this(Configuration.getDefaultApiClient());
    }

    public SenderHealthApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getSenderHealth
     * @param period Time period for health calculation (optional, default to 30d)
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> Sender health score </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call getSenderHealthCall(@javax.annotation.Nullable String period, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v1/sender-health";
    ...
    private okhttp3.Call getSenderHealthValidateBeforeCall(@javax.annotation.Nullable String period, final ApiCallback _callback) throws ApiException {
        return getSenderHealthCall(period, _callback);
     ...
     */
    public GetSenderHealth200Response getSenderHealth(@javax.annotation.Nullable String period) throws ApiException {
        ApiResponse<GetSenderHealth200Response> localVarResp = getSenderHealthWithHttpInfo(period);
     ...
     * Get an aggregate sender health score (0-100) across all sending domains. Factors in delivery rate, bounce rate, complaint rate, and authentication status.
     * @param period Time period for health calculation (optional, default to 30d)
     * @return ApiResponse&lt;GetSenderHealth200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<GetSenderHealth200Response> getSenderHealthWithHttpInfo(@javax.annotation.Nullable String period) throws ApiException {
        okhttp3.Call localVarCall = getSenderHealthValidateBeforeCall(period, null);
        Type localVarReturnType = new TypeToken<GetSenderHealth200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get sender health score (asynchronously)
     * Get an aggregate sender health score (0-100) across all sending domains. Factors in delivery rate, bounce rate, complaint rate, and authentication status.
     * @param period Time period for health calculation (optional, default to 30d)
     ...
     */
    public okhttp3.Call getSenderHealthAsync(@javax.annotation.Nullable String period, final ApiCallback<GetSenderHealth200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSenderHealthValidateBeforeCall(period, _callback);
        Type localVarReturnType = new TypeToken<GetSenderHealth200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getSenderHealthTrend
     * @param period Time period for trend data (optional, default to 30d)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Sender health trend </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden - Insufficient permissions or no credits </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized - Invalid or missing API key </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getSenderHealthTrendCall(@javax.annotation.Nullable String period, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v1/sender-health/trend";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSenderHealthTrendValidateBeforeCall(@javax.annotation.Nullable String period, final ApiCallback _callback) throws ApiException {
        return getSenderHealthTrendCall(period, _callback);
     ...
     */
    public GetSenderHealthTrend200Response getSenderHealthTrend(@javax.annotation.Nullable String period) throws ApiException {
        ApiResponse<GetSenderHealthTrend200Response> localVarResp = getSenderHealthTrendWithHttpInfo(period);
        return localVarResp.getData();
    }
     ...
     * Get historical sender health scores over time for trend analysis. Returns daily data points for the requested period.
     * @param period Time period for trend data (optional, default to 30d)
     * @return ApiResponse&lt;GetSenderHealthTrend200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<GetSenderHealthTrend200Response> getSenderHealthTrendWithHttpInfo(@javax.annotation.Nullable String period) throws ApiException {
        okhttp3.Call localVarCall = getSenderHealthTrendValidateBeforeCall(period, null);
        Type localVarReturnType = new TypeToken<GetSenderHealthTrend200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get sender health trend (asynchronously)
     * Get historical sender health scores over time for trend analysis. Returns daily data points for the requested period.
     * @param period Time period for trend data (optional, default to 30d)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getSenderHealthTrendAsync(@javax.annotation.Nullable String period, final ApiCallback<GetSenderHealthTrend200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSenderHealthTrendValidateBeforeCall(period, _callback);
        Type localVarReturnType = new TypeToken<GetSenderHealthTrend200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
