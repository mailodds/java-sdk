...
public class HealthCheck200Response {
   ...
   * @return the HealthCheck200Response instance itself
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, timestamp, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HealthCheck200Response>() {
           ...
           public HealthCheck200Response read(JsonReader in) throws IOException {
             ...
             HealthCheck200Response instance = thisAdapter.fromJsonTree(jsonObj);
