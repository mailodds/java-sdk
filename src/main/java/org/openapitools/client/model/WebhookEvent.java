...
public class WebhookEvent {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(event, timestamp, job, messageId, accountId, domainId, to, status, smtpCode, smtpResponse, mxHost, bounceType, enhancedStatusCode, attempts, isp, isMpp, ipAddress, userAgent, isBot, linkUrl, linkIndex, additionalProperties);
  }
