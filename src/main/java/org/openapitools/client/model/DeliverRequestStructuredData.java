...
public class DeliverRequestStructuredData extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeliverRequestStructuredData.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeliverRequestStructuredData' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeliverRequestStructuredData>() {
                @Override
                public void write(JsonWriter out, DeliverRequestStructuredData value) throws IOException {
                ...
                @Override
                public DeliverRequestStructuredData read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        DeliverRequestStructuredData ret = new DeliverRequestStructuredData();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DeliverRequestStructuredData: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeliverRequestStructuredData() {
        super("oneOf", Boolean.FALSE);
    }

    public DeliverRequestStructuredData(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DeliverRequestStructuredData.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to DeliverRequestStructuredData
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DeliverRequestStructuredData with oneOf schemas: List<Object>, Object, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of DeliverRequestStructuredData given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DeliverRequestStructuredData
     * @throws IOException if the JSON string is invalid with respect to DeliverRequestStructuredData
     */
    public static DeliverRequestStructuredData fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DeliverRequestStructuredData.class);
    }

    /**
     * Convert an instance of DeliverRequestStructuredData to an JSON string
     *
     * @return JSON string
     */
