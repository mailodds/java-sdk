...
public class JobSummary {
   ...
   * @return the JobSummary instance itself
   */
  public JobSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.valid, jobSummary.valid) &&
        ...
        Objects.equals(this.additionalProperties, jobSummary.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(valid, invalid, catchAll, doNotMail, unknown, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JobSummary>() {
           ...
           public JobSummary read(JsonReader in) throws IOException {
             ...
             JobSummary instance = thisAdapter.fromJsonTree(jsonObj);
