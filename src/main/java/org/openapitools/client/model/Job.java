...
import org.openapitools.client.model.JobArtifacts;
...
public class Job {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, status, totalCount, processedCount, summary, createdAt, startedAt, completedAt, resultsExpireAt, metadata, errorMessage, requestId, artifacts, additionalProperties);
  }
