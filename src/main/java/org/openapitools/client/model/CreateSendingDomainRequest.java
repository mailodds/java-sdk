...
public class CreateSendingDomainRequest {
  ...
  public CreateSendingDomainRequest() {
  }

  public CreateSendingDomainRequest domain(@javax.annotation.Nonnull String domain) {
    this.domain = domain;
    return this;
  }
   ...
   * @return the CreateSendingDomainRequest instance itself
   */
  public CreateSendingDomainRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSendingDomainRequest createSendingDomainRequest = (CreateSendingDomainRequest) o;
    return Objects.equals(this.domain, createSendingDomainRequest.domain)&&
        Objects.equals(this.additionalProperties, createSendingDomainRequest.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSendingDomainRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSendingDomainRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateSendingDomainRequest is not found in the empty JSON string", CreateSendingDomainRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateSendingDomainRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSendingDomainRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSendingDomainRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSendingDomainRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSendingDomainRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSendingDomainRequest>() {
           @Override
           public void write(JsonWriter out, CreateSendingDomainRequest value) throws IOException {
           ...
           @Override
           public CreateSendingDomainRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateSendingDomainRequest instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CreateSendingDomainRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSendingDomainRequest
   * @throws IOException if the JSON string is invalid with respect to CreateSendingDomainRequest
   */
  public static CreateSendingDomainRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSendingDomainRequest.class);
  }

  /**
   * Convert an instance of CreateSendingDomainRequest to an JSON string
   *
   * @return JSON string
   */
