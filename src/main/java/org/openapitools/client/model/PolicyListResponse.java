...
import org.openapitools.client.model.PolicyListResponseLimits;
...
public class PolicyListResponse {
  ...
  public PolicyListResponse requestId(@javax.annotation.Nullable String requestId) {
   ...
   * @return the PolicyListResponse instance itself
   */
  public PolicyListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.schemaVersion, policyListResponse.schemaVersion) &&
        Objects.equals(this.requestId, policyListResponse.requestId) &&
        Objects.equals(this.policies, policyListResponse.policies) &&
        Objects.equals(this.limits, policyListResponse.limits)&&
        Objects.equals(this.additionalProperties, policyListResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, policies, limits, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "policies", "limits"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PolicyListResponse>() {
           ...
           public PolicyListResponse read(JsonReader in) throws IOException {
             ...
             PolicyListResponse instance = thisAdapter.fromJsonTree(jsonObj);
