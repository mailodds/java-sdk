...
import org.openapitools.client.model.ValidateBatch200ResponseSummary;
...
public class ValidateBatch200Response {
  ...
  public ValidateBatch200Response requestId(@javax.annotation.Nullable String requestId) {
   ...
   * @return the ValidateBatch200Response instance itself
   */
  public ValidateBatch200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.schemaVersion, validateBatch200Response.schemaVersion) &&
        Objects.equals(this.requestId, validateBatch200Response.requestId) &&
        ...
        Objects.equals(this.additionalProperties, validateBatch200Response.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, total, summary, results, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("schema_version", "request_id", "total", "summary", "results"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ValidateBatch200Response>() {
           ...
           public ValidateBatch200Response read(JsonReader in) throws IOException {
             ...
             ValidateBatch200Response instance = thisAdapter.fromJsonTree(jsonObj);
