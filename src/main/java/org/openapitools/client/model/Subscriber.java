...
public class Subscriber {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, listId, email, name, status, consentSourceIp, consentPageUrl, consentFormId, consentTimestamp, confirmedAt, unsubscribedAt, validationResult, metadata, createdAt, additionalProperties);
  }
