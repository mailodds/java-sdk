...
public class ValidationResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, requestId, email, status, action, subStatus, domain, mxFound, mxHost, smtpCheck, catchAll, disposable, roleAccount, freeProvider, depth, processedAt, suggestedEmail, retryAfterMs, hasSpf, hasDmarc, dmarcPolicy, dnsblListed, suppressionMatch, policyApplied, additionalProperties);
  }
