...
public class GetPresignedUploadRequest {
  ...
  public GetPresignedUploadRequest() {
  }

  public GetPresignedUploadRequest filename(@javax.annotation.Nonnull String filename) {
  ...
  public GetPresignedUploadRequest contentType(@javax.annotation.Nullable String contentType) {
   ...
   * @return the GetPresignedUploadRequest instance itself
   */
  public GetPresignedUploadRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GetPresignedUploadRequest getPresignedUploadRequest = (GetPresignedUploadRequest) o;
    return Objects.equals(this.filename, getPresignedUploadRequest.filename) &&
        Objects.equals(this.contentType, getPresignedUploadRequest.contentType)&&
        Objects.equals(this.additionalProperties, getPresignedUploadRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filename, contentType, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("filename", "content_type"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPresignedUploadRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPresignedUploadRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetPresignedUploadRequest is not found in the empty JSON string", GetPresignedUploadRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPresignedUploadRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPresignedUploadRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPresignedUploadRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPresignedUploadRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPresignedUploadRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPresignedUploadRequest>() {
           @Override
           public void write(JsonWriter out, GetPresignedUploadRequest value) throws IOException {
           ...
           @Override
           public GetPresignedUploadRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             GetPresignedUploadRequest instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of GetPresignedUploadRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPresignedUploadRequest
   * @throws IOException if the JSON string is invalid with respect to GetPresignedUploadRequest
   */
  public static GetPresignedUploadRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPresignedUploadRequest.class);
  }

  /**
   * Convert an instance of GetPresignedUploadRequest to an JSON string
   *
   * @return JSON string
   */
