...
/**
 * API tests for AgentControlPlaneApi
 */
@Disabled
public class AgentControlPlaneApiTest {

    private final AgentControlPlaneApi api = new AgentControlPlaneApi();
     ...
     */
    @Test
    public void getMcpCapabilitiesTest() throws ApiException {
        McpCapabilities response = api.getMcpCapabilities();
