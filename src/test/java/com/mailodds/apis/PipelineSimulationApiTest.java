...
/**
 * API tests for PipelineSimulationApi
 */
@Disabled
public class PipelineSimulationApiTest {

    private final PipelineSimulationApi api = new PipelineSimulationApi();
     ...
     */
    @Test
    public void simulatePipelineTest() throws ApiException {
        api.simulatePipeline();
