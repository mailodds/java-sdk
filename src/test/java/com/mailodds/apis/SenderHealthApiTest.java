...
/**
 * API tests for SenderHealthApi
 */
@Disabled
public class SenderHealthApiTest {

    private final SenderHealthApi api = new SenderHealthApi();
     ...
     */
    @Test
    public void getSenderHealthTest() throws ApiException {
        String period = null;
        GetSenderHealth200Response response = api.getSenderHealth(period);
     ...
     */
    @Test
    public void getSenderHealthTrendTest() throws ApiException {
        String period = null;
        GetSenderHealthTrend200Response response = api.getSenderHealthTrend(period);
        // TODO: test validations
    }
