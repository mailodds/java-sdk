...
/**
 * API tests for MessageEventsApi
 */
@Disabled
public class MessageEventsApiTest {

    private final MessageEventsApi api = new MessageEventsApi();
     ...
     */
    @Test
    public void getMessageEventsTest() throws ApiException {
        String messageId = null;
        GetMessageEvents200Response response = api.getMessageEvents(messageId);
