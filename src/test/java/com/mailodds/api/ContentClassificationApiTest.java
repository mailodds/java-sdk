...
/**
 * API tests for ContentClassificationApi
 */
@Disabled
public class ContentClassificationApiTest {

    private final ContentClassificationApi api = new ContentClassificationApi();
     ...
     */
    @Test
    public void classifyContentTest() throws ApiException {
        ClassifyContentRequest classifyContentRequest = null;
        ClassifyContent200Response response = api.classifyContent(classifyContentRequest);
